...
*Defined in [types/opencv/DescriptorMatcher.ts:20](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L20)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:22](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L22)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:29](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L29)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:31](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L31)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:33](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L33)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:35](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L35)*
...
▸ **knnMatch**(`queryDescriptors`: InputArray, `trainDescriptors`: InputArray, `matches`: any, `k`: [int](../modules/_types_opencv__hacks_.md#int), `mask?`: InputArray, `compactResult?`: [bool](../modules/_types_opencv__hacks_.md#bool)): *InputArray*

*Defined in [types/opencv/DescriptorMatcher.ts:59](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L59)*
...
`matches` | any | Matches. Each matches[i] is k or less matches for the same query descriptor.  |
...
▸ **knnMatch**(`queryDescriptors`: InputArray, `matches`: any, `k`: [int](../modules/_types_opencv__hacks_.md#int), `masks?`: InputArrayOfArrays, `compactResult?`: [bool](../modules/_types_opencv__hacks_.md#bool)): *InputArray*

*Defined in [types/opencv/DescriptorMatcher.ts:79](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L79)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:99](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L99)*
...
`queryDescriptors` | InputArray | Query set of descriptors.  |
`trainDescriptors` | InputArray | Train set of descriptors. This set is not added to the train descriptors collection stored in the class object.  |
`matches` | any | Matches. If a query descriptor is masked out in mask , no match is added for this descriptor. So, matches size may be smaller than the query descriptors count.  |
`mask?` | InputArray | Mask specifying permissible matches between an input query and train matrices of descriptors.  |
...
*Defined in [types/opencv/DescriptorMatcher.ts:113](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L113)*
...
▸ **radiusMatch**(`queryDescriptors`: InputArray, `trainDescriptors`: InputArray, `matches`: any, `maxDistance`: [float](../modules/_types_opencv__hacks_.md#float), `mask?`: InputArray, `compactResult?`: [bool](../modules/_types_opencv__hacks_.md#bool)): *InputArray*

*Defined in [types/opencv/DescriptorMatcher.ts:138](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L138)*
...
▸ **radiusMatch**(`queryDescriptors`: InputArray, `matches`: any, `maxDistance`: [float](../modules/_types_opencv__hacks_.md#float), `masks?`: InputArrayOfArrays, `compactResult?`: [bool](../modules/_types_opencv__hacks_.md#bool)): *InputArray*

*Defined in [types/opencv/DescriptorMatcher.ts:159](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L159)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:161](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L161)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:163](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L163)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:171](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L171)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:173](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L173)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:175](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L175)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:177](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L177)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:184](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L184)*
...
*Defined in [types/opencv/DescriptorMatcher.ts:186](https://github.com/cancerberoSgx/mirada/blob/c8721d6/mirada/src/types/opencv/DescriptorMatcher.ts#L186)*
