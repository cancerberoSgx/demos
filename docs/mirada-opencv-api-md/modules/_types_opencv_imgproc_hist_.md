...
[Globals](../README.md) › ["types/opencv/imgproc_hist"](_types_opencv_imgproc_hist_.md)
...
*Defined in [types/opencv/imgproc_hist.ts:315](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L315)*
...
*Defined in [types/opencv/imgproc_hist.ts:292](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L292)*
...
*Defined in [types/opencv/imgproc_hist.ts:278](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L278)*
...
*Defined in [types/opencv/imgproc_hist.ts:302](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L302)*
...
*Defined in [types/opencv/imgproc_hist.ts:272](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L272)*
...
*Defined in [types/opencv/imgproc_hist.ts:294](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L294)*
...
*Defined in [types/opencv/imgproc_hist.ts:284](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L284)*
...
*Defined in [types/opencv/imgproc_hist.ts:309](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L309)*
...
*Defined in [types/opencv/imgproc_hist.ts:246](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L246)*
...
`signature2` | InputArray | Second signature of the same format as signature1 , though the number of rows may be different. The total weights may be different. In this case an extra "dummy" point is added to either signature1 or signature2. The weights must be non-negative and have at least one non-zero value.  |
`distType` | [int](_types_opencv__hacks_.md#int) | Used metric. See DistanceTypes.  |
`cost?` | InputArray | User-defined $\texttt{size1}\times \texttt{size2}$ cost matrix. Also, if a cost matrix is used, lower boundary lowerBound cannot be calculated because it needs a metric function.  |
...
*Defined in [types/opencv/imgproc_hist.ts:49](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L49)*
...
`hist` | InputArray | Input histogram that can be dense or sparse.  |
...
*Defined in [types/opencv/imgproc_hist.ts:55](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L55)*
...
*Defined in [types/opencv/imgproc_hist.ts:61](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L61)*
...
*Defined in [types/opencv/imgproc_hist.ts:161](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L161)*
...
`mask` | InputArray | Optional mask. If the matrix is not empty, it must be an 8-bit array of the same size as images[i] . The non-zero mask elements mark the array elements counted in the histogram.  |
...
*Defined in [types/opencv/imgproc_hist.ts:169](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L169)*
...
*Defined in [types/opencv/imgproc_hist.ts:175](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L175)*
...
*Defined in [types/opencv/imgproc_hist.ts:194](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L194)*
...
Name | Type | Description |
------ | ------ | ------ |
`H1` | InputArray | First compared histogram.  |
`H2` | InputArray | Second compared histogram of the same size as H1 .  |
...
*Defined in [types/opencv/imgproc_hist.ts:200](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L200)*
...
*Defined in [types/opencv/imgproc_hist.ts:208](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L208)*
...
*Defined in [types/opencv/imgproc_hist.ts:262](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L262)*
...
*Defined in [types/opencv/imgproc_hist.ts:264](https://github.com/cancerberoSgx/mirada/blob/170e57c/mirada/src/types/opencv/imgproc_hist.ts#L264)*
