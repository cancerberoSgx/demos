[ojos](../README.md) › ["op/inRange"](../modules/_op_inrange_.md) › [InRange](_op_inrange_.inrange.md)
...
* [AbstractOperation](_op_abstractoperation_.abstractoperation.md)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)›

  ↳ **InRange**

## Implements

* [ImageOperation](../interfaces/_op_types_.imageoperation.md)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)›

## Index

### Constructors

* [constructor](_op_inrange_.inrange.md#constructor)

### Properties

* [defaultOptions](_op_inrange_.inrange.md#protected-optional-defaultoptions)
* [description](_op_inrange_.inrange.md#description)
* [isInPlace](_op_inrange_.inrange.md#isinplace)
* [name](_op_inrange_.inrange.md#name)
* [noDst](_op_inrange_.inrange.md#nodst)
* [noInPlace](_op_inrange_.inrange.md#noinplace)
* [optionsOrder](_op_inrange_.inrange.md#optional-optionsorder)
* [sameSizeAndType](_op_inrange_.inrange.md#samesizeandtype)
* [validChannels](_op_inrange_.inrange.md#validchannels)
* [validateEachExec](_op_inrange_.inrange.md#protected-validateeachexec)
* [validated](_op_inrange_.inrange.md#protected-validated)

### Methods

* [_exec](_op_inrange_.inrange.md#protected-_exec)
* [afterExec](_op_inrange_.inrange.md#protected-afterexec)
* [allChannels](_op_inrange_.inrange.md#protected-allchannels)
* [checkDst](_op_inrange_.inrange.md#protected-checkdst)
* [checkInPlaceAfter](_op_inrange_.inrange.md#protected-checkinplaceafter)
* [checkInPlaceBefore](_op_inrange_.inrange.md#protected-checkinplacebefore)
* [checkInputImage](_op_inrange_.inrange.md#protected-checkinputimage)
* [checkOptions](_op_inrange_.inrange.md#protected-checkoptions)
* [exec](_op_inrange_.inrange.md#exec)
* [resolveOptionsObject](_op_inrange_.inrange.md#resolveoptionsobject)
* [validate](_op_inrange_.inrange.md#protected-validate)

## Constructors

###  constructor

\+ **new InRange**(`defaultOptions?`: [T](undefined)): *[InRange](_op_inrange_.inrange.md)*
...
**Returns:** *[InRange](_op_inrange_.inrange.md)*
...
*Defined in [op/inRange.ts:24](https://github.com/cancerberoSgx/mirada/blob/3544b58/ojos/src/op/inRange.ts#L24)*
...
*Defined in [op/inRange.ts:23](https://github.com/cancerberoSgx/mirada/blob/3544b58/ojos/src/op/inRange.ts#L23)*
...
▸ **_exec**(`o`: [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)): *void*

*Overrides [AbstractOperation](_op_abstractoperation_.abstractoperation.md).[_exec](_op_abstractoperation_.abstractoperation.md#protected-abstract-_exec)*

*Defined in [op/inRange.ts:25](https://github.com/cancerberoSgx/mirada/blob/3544b58/ojos/src/op/inRange.ts#L25)*

**Parameters:**

Name | Type |
------ | ------ |
`o` | [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md) |
...
▸ **afterExec**(`options`: [MandatoryDst](../modules/_op_abstractoperation_.md#mandatorydst)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)›): *void*
...
Name | Type |
------ | ------ |
`options` | [MandatoryDst](../modules/_op_abstractoperation_.md#mandatorydst)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)› |
...
▸ **allChannels**(`o`: [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md) & [WithChannels](../interfaces/_op_types_.withchannels.md), `op`: function): *void*
...
▪ **o**: *[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md) & [WithChannels](../interfaces/_op_types_.withchannels.md)*

▪ **op**: *function*

▸ (`o`: [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)): *void*
...
▸ **checkDst**(`options`: [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)): *void*
...
Name | Type |
------ | ------ |
`options` | [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md) |
...
▸ **checkInputImage**(`o`: [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)): *void*
...
▸ **exec**(...`o_`: [OperationExecParams](../modules/_op_types_.md#operationexecparams)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)›): *Mat*
...
Name | Type |
------ | ------ |
`...o_` | [OperationExecParams](../modules/_op_types_.md#operationexecparams)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)› |
...
▸ **resolveOptionsObject**(...`o`: [OperationExecParams](../modules/_op_types_.md#operationexecparams)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)›): *[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md) | undefined*
...
Name | Type |
------ | ------ |
`...o` | [OperationExecParams](../modules/_op_types_.md#operationexecparams)‹[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)› |

**Returns:** *[InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md) | undefined*

___

### `Protected` validate

▸ **validate**(`o`: [InRangeOptions](../interfaces/_op_inrange_.inrangeoptions.md)): *string | undefined*
