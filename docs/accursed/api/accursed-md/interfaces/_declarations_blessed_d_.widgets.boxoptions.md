[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [Widgets](../modules/_declarations_blessed_d_.widgets.md) › [BoxOptions](_declarations_blessed_d_.widgets.boxoptions.md)

# Interface: BoxOptions

## Hierarchy

  ↳ [ScrollableTextOptions](_declarations_blessed_d_.widgets.scrollabletextoptions.md)

  ↳ **BoxOptions**

  ↳ [BorderBoxOptions](_blessed_borderbox_.borderboxoptions.md)

  ↳ [LineOptions](_declarations_blessed_d_.widgets.lineoptions.md)

  ↳ [BigTextOptions](_declarations_blessed_d_.widgets.bigtextoptions.md)

  ↳ [ListOptions](_declarations_blessed_d_.widgets.listoptions.md)

  ↳ [ListbarOptions](_declarations_blessed_d_.widgets.listbaroptions.md)

  ↳ [FormOptions](_declarations_blessed_d_.widgets.formoptions.md)

  ↳ [InputOptions](_declarations_blessed_d_.widgets.inputoptions.md)

  ↳ [ButtonOptions](_declarations_blessed_d_.widgets.buttonoptions.md)

  ↳ [CheckboxOptions](_declarations_blessed_d_.widgets.checkboxoptions.md)

  ↳ [RadioSetOptions](_declarations_blessed_d_.widgets.radiosetoptions.md)

  ↳ [PromptOptions](_declarations_blessed_d_.widgets.promptoptions.md)

  ↳ [QuestionOptions](_declarations_blessed_d_.widgets.questionoptions.md)

  ↳ [MessageOptions](_declarations_blessed_d_.widgets.messageoptions.md)

  ↳ [LoadingOptions](_declarations_blessed_d_.widgets.loadingoptions.md)

  ↳ [ProgressBarOptions](_declarations_blessed_d_.widgets.progressbaroptions.md)

  ↳ [TableOptions](_declarations_blessed_d_.widgets.tableoptions.md)

  ↳ [TerminalOptions](_declarations_blessed_d_.widgets.terminaloptions.md)

  ↳ [ImageOptions](_declarations_blessed_d_.widgets.imageoptions.md)

  ↳ [ANSIImageOptions](_declarations_blessed_d_.widgets.ansiimageoptions.md)

  ↳ [OverlayImageOptions](_declarations_blessed_d_.widgets.overlayimageoptions.md)

  ↳ [VideoOptions](_declarations_blessed_d_.widgets.videooptions.md)

  ↳ [CanvasOptions](_declarations_blessed_contrib_d_.blessedcontrib.widgets.canvasoptions.md)

  ↳ [TreeOptions](_declarations_blessed_contrib_d_.blessedcontrib.widgets.treeoptions.md)

## Index

### Properties

* [_data](_declarations_blessed_d_.widgets.boxoptions.md#optional-_data)
* [align](_declarations_blessed_d_.widgets.boxoptions.md#optional-align)
* [alwaysScroll](_declarations_blessed_d_.widgets.boxoptions.md#optional-alwaysscroll)
* [autoFocus](_declarations_blessed_d_.widgets.boxoptions.md#optional-autofocus)
* [baseLimit](_declarations_blessed_d_.widgets.boxoptions.md#optional-baselimit)
* [bg](_declarations_blessed_d_.widgets.boxoptions.md#optional-bg)
* [bindings](_declarations_blessed_d_.widgets.boxoptions.md#optional-bindings)
* [blink](_declarations_blessed_d_.widgets.boxoptions.md#optional-blink)
* [bold](_declarations_blessed_d_.widgets.boxoptions.md#optional-bold)
* [border](_declarations_blessed_d_.widgets.boxoptions.md#optional-border)
* [bottom](_declarations_blessed_d_.widgets.boxoptions.md#optional-bottom)
* [ch](_declarations_blessed_d_.widgets.boxoptions.md#optional-ch)
* [children](_declarations_blessed_d_.widgets.boxoptions.md#optional-children)
* [clickable](_declarations_blessed_d_.widgets.boxoptions.md#optional-clickable)
* [content](_declarations_blessed_d_.widgets.boxoptions.md#optional-content)
* [dockBorders](_declarations_blessed_d_.widgets.boxoptions.md#optional-dockborders)
* [draggable](_declarations_blessed_d_.widgets.boxoptions.md#optional-draggable)
* [effects](_declarations_blessed_d_.widgets.boxoptions.md#optional-effects)
* [fg](_declarations_blessed_d_.widgets.boxoptions.md#optional-fg)
* [fixed](_declarations_blessed_d_.widgets.boxoptions.md#optional-fixed)
* [focusEffects](_declarations_blessed_d_.widgets.boxoptions.md#optional-focuseffects)
* [focusable](_declarations_blessed_d_.widgets.boxoptions.md#optional-focusable)
* [focused](_declarations_blessed_d_.widgets.boxoptions.md#optional-focused)
* [height](_declarations_blessed_d_.widgets.boxoptions.md#optional-height)
* [hidden](_declarations_blessed_d_.widgets.boxoptions.md#optional-hidden)
* [hoverBg](_declarations_blessed_d_.widgets.boxoptions.md#optional-hoverbg)
* [hoverEffects](_declarations_blessed_d_.widgets.boxoptions.md#optional-hovereffects)
* [hoverText](_declarations_blessed_d_.widgets.boxoptions.md#optional-hovertext)
* [input](_declarations_blessed_d_.widgets.boxoptions.md#optional-input)
* [inverse](_declarations_blessed_d_.widgets.boxoptions.md#optional-inverse)
* [invisible](_declarations_blessed_d_.widgets.boxoptions.md#optional-invisible)
* [keyable](_declarations_blessed_d_.widgets.boxoptions.md#optional-keyable)
* [keys](_declarations_blessed_d_.widgets.boxoptions.md#optional-keys)
* [label](_declarations_blessed_d_.widgets.boxoptions.md#optional-label)
* [left](_declarations_blessed_d_.widgets.boxoptions.md#optional-left)
* [mouse](_declarations_blessed_d_.widgets.boxoptions.md#optional-mouse)
* [name](_declarations_blessed_d_.widgets.boxoptions.md#optional-name)
* [noOverflow](_declarations_blessed_d_.widgets.boxoptions.md#optional-nooverflow)
* [padding](_declarations_blessed_d_.widgets.boxoptions.md#optional-padding)
* [parent](_declarations_blessed_d_.widgets.boxoptions.md#optional-parent)
* [position](_declarations_blessed_d_.widgets.boxoptions.md#optional-position)
* [ref](_declarations_blessed_d_.widgets.boxoptions.md#optional-ref)
* [right](_declarations_blessed_d_.widgets.boxoptions.md#optional-right)
* [screen](_declarations_blessed_d_.widgets.boxoptions.md#optional-screen)
* [scrollable](_declarations_blessed_d_.widgets.boxoptions.md#optional-scrollable)
* [scrollbar](_declarations_blessed_d_.widgets.boxoptions.md#optional-scrollbar)
* [shadow](_declarations_blessed_d_.widgets.boxoptions.md#optional-shadow)
* [shrink](_declarations_blessed_d_.widgets.boxoptions.md#optional-shrink)
* [style](_declarations_blessed_d_.widgets.boxoptions.md#optional-style)
* [tags](_declarations_blessed_d_.widgets.boxoptions.md#optional-tags)
* [top](_declarations_blessed_d_.widgets.boxoptions.md#optional-top)
* [transparent](_declarations_blessed_d_.widgets.boxoptions.md#optional-transparent)
* [underline](_declarations_blessed_d_.widgets.boxoptions.md#optional-underline)
* [valign](_declarations_blessed_d_.widgets.boxoptions.md#optional-valign)
* [vi](_declarations_blessed_d_.widgets.boxoptions.md#optional-vi)
* [width](_declarations_blessed_d_.widgets.boxoptions.md#optional-width)
* [wrap](_declarations_blessed_d_.widgets.boxoptions.md#optional-wrap)
