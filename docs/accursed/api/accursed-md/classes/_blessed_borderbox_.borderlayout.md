[accursed](../README.md) › [Globals](../globals.md) › ["blessed/borderBox"](../modules/_blessed_borderbox_.md) › [BorderLayout](_blessed_borderbox_.borderlayout.md)

# Class: BorderLayout <**Options**>
...
* [constructor](_blessed_borderbox_.borderlayout.md#constructor)

### Properties

* [$](_blessed_borderbox_.borderlayout.md#$)
* [_](_blessed_borderbox_.borderlayout.md#_)
* [_label](_blessed_borderbox_.borderlayout.md#optional-_label)
* [_noFill](_blessed_borderbox_.borderlayout.md#optional-_nofill)
* [abottom](_blessed_borderbox_.borderlayout.md#abottom)
* [aleft](_blessed_borderbox_.borderlayout.md#aleft)
* [aright](_blessed_borderbox_.borderlayout.md#aright)
* [atop](_blessed_borderbox_.borderlayout.md#atop)
* [bg](_blessed_borderbox_.borderlayout.md#bg)
* [bold](_blessed_borderbox_.borderlayout.md#bold)
* [border](_blessed_borderbox_.borderlayout.md#border)
* [bottom](_blessed_borderbox_.borderlayout.md#bottom)
* [children](_blessed_borderbox_.borderlayout.md#children)
* [content](_blessed_borderbox_.borderlayout.md#content)
* [data](_blessed_borderbox_.borderlayout.md#data)
* [detached](_blessed_borderbox_.borderlayout.md#detached)
* [draggable](_blessed_borderbox_.borderlayout.md#draggable)
* [fg](_blessed_borderbox_.borderlayout.md#fg)
* [focusable](_blessed_borderbox_.borderlayout.md#focusable)
* [height](_blessed_borderbox_.borderlayout.md#height)
* [hidden](_blessed_borderbox_.borderlayout.md#hidden)
* [iheight](_blessed_borderbox_.borderlayout.md#iheight)
* [ileft](_blessed_borderbox_.borderlayout.md#ileft)
* [index](_blessed_borderbox_.borderlayout.md#index)
* [itop](_blessed_borderbox_.borderlayout.md#itop)
* [iwidth](_blessed_borderbox_.borderlayout.md#iwidth)
* [left](_blessed_borderbox_.borderlayout.md#left)
* [lpos](_blessed_borderbox_.borderlayout.md#lpos)
* [name](_blessed_borderbox_.borderlayout.md#name)
* [options](_blessed_borderbox_.borderlayout.md#options)
* [padding](_blessed_borderbox_.borderlayout.md#padding)
* [parent](_blessed_borderbox_.borderlayout.md#optional-parent)
* [position](_blessed_borderbox_.borderlayout.md#position)
* [rbottom](_blessed_borderbox_.borderlayout.md#rbottom)
* [right](_blessed_borderbox_.borderlayout.md#right)
* [rleft](_blessed_borderbox_.borderlayout.md#rleft)
* [rright](_blessed_borderbox_.borderlayout.md#rright)
* [rtop](_blessed_borderbox_.borderlayout.md#rtop)
* [screen](_blessed_borderbox_.borderlayout.md#screen)
* [shrink](_blessed_borderbox_.borderlayout.md#shrink)
* [style](_blessed_borderbox_.borderlayout.md#style)
* [top](_blessed_borderbox_.borderlayout.md#top)
* [tpadding](_blessed_borderbox_.borderlayout.md#tpadding)
* [type](_blessed_borderbox_.borderlayout.md#type)
* [uid](_blessed_borderbox_.borderlayout.md#uid)
* [underline](_blessed_borderbox_.borderlayout.md#underline)
* [visible](_blessed_borderbox_.borderlayout.md#visible)
* [width](_blessed_borderbox_.borderlayout.md#width)
* [defaultMaxListeners](_blessed_borderbox_.borderlayout.md#static-defaultmaxlisteners)

### Methods

* [_align](_blessed_borderbox_.borderlayout.md#_align)
* [_getBottom](_blessed_borderbox_.borderlayout.md#_getbottom)
* [_getCoords](_blessed_borderbox_.borderlayout.md#_getcoords)
* [_getHeight](_blessed_borderbox_.borderlayout.md#_getheight)
* [_getLeft](_blessed_borderbox_.borderlayout.md#_getleft)
* [_getPos](_blessed_borderbox_.borderlayout.md#_getpos)
* [_getRight](_blessed_borderbox_.borderlayout.md#_getright)
* [_getShrink](_blessed_borderbox_.borderlayout.md#_getshrink)
* [_getShrinkBox](_blessed_borderbox_.borderlayout.md#_getshrinkbox)
* [_getTop](_blessed_borderbox_.borderlayout.md#_gettop)
* [_getWidth](_blessed_borderbox_.borderlayout.md#_getwidth)
* [_parseAttr](_blessed_borderbox_.borderlayout.md#_parseattr)
* [_parseTags](_blessed_borderbox_.borderlayout.md#_parsetags)
* [_wrapContent](_blessed_borderbox_.borderlayout.md#_wrapcontent)
* [addListener](_blessed_borderbox_.borderlayout.md#addlistener)
* [append](_blessed_borderbox_.borderlayout.md#append)
* [clearBaseLine](_blessed_borderbox_.borderlayout.md#clearbaseline)
* [clearLine](_blessed_borderbox_.borderlayout.md#clearline)
* [clearPos](_blessed_borderbox_.borderlayout.md#clearpos)
* [collectAncestors](_blessed_borderbox_.borderlayout.md#collectancestors)
* [collectDescendants](_blessed_borderbox_.borderlayout.md#collectdescendants)
* [deleteBottom](_blessed_borderbox_.borderlayout.md#deletebottom)
* [deleteLine](_blessed_borderbox_.borderlayout.md#deleteline)
* [deleteTop](_blessed_borderbox_.borderlayout.md#deletetop)
* [destroy](_blessed_borderbox_.borderlayout.md#destroy)
* [detach](_blessed_borderbox_.borderlayout.md#detach)
* [disableDrag](_blessed_borderbox_.borderlayout.md#disabledrag)
* [emit](_blessed_borderbox_.borderlayout.md#emit)
* [emitAncestors](_blessed_borderbox_.borderlayout.md#emitancestors)
* [emitDescendants](_blessed_borderbox_.borderlayout.md#emitdescendants)
* [enableDrag](_blessed_borderbox_.borderlayout.md#enabledrag)
* [enableInput](_blessed_borderbox_.borderlayout.md#enableinput)
* [enableKeys](_blessed_borderbox_.borderlayout.md#enablekeys)
* [enableMouse](_blessed_borderbox_.borderlayout.md#enablemouse)
* [eventNames](_blessed_borderbox_.borderlayout.md#eventnames)
* [focus](_blessed_borderbox_.borderlayout.md#focus)
* [forAncestors](_blessed_borderbox_.borderlayout.md#forancestors)
* [forDescendants](_blessed_borderbox_.borderlayout.md#fordescendants)
* [free](_blessed_borderbox_.borderlayout.md#free)
* [get](_blessed_borderbox_.borderlayout.md#get)
* [getBaseLine](_blessed_borderbox_.borderlayout.md#getbaseline)
* [getContent](_blessed_borderbox_.borderlayout.md#getcontent)
* [getLast](_blessed_borderbox_.borderlayout.md#getlast)
* [getLastCoords](_blessed_borderbox_.borderlayout.md#getlastcoords)
* [getLine](_blessed_borderbox_.borderlayout.md#getline)
* [getLines](_blessed_borderbox_.borderlayout.md#getlines)
* [getMaxListeners](_blessed_borderbox_.borderlayout.md#getmaxlisteners)
* [getScreenLines](_blessed_borderbox_.borderlayout.md#getscreenlines)
* [getText](_blessed_borderbox_.borderlayout.md#gettext)
* [hasAncestor](_blessed_borderbox_.borderlayout.md#hasancestor)
* [hasDescendant](_blessed_borderbox_.borderlayout.md#hasdescendant)
* [hide](_blessed_borderbox_.borderlayout.md#hide)
* [insert](_blessed_borderbox_.borderlayout.md#insert)
* [insertAfter](_blessed_borderbox_.borderlayout.md#insertafter)
* [insertBefore](_blessed_borderbox_.borderlayout.md#insertbefore)
* [insertBottom](_blessed_borderbox_.borderlayout.md#insertbottom)
* [insertLine](_blessed_borderbox_.borderlayout.md#insertline)
* [insertTop](_blessed_borderbox_.borderlayout.md#inserttop)
* [isRendered](_blessed_borderbox_.borderlayout.md#isrendered)
* [key](_blessed_borderbox_.borderlayout.md#key)
* [kill](_blessed_borderbox_.borderlayout.md#kill)
* [listenerCount](_blessed_borderbox_.borderlayout.md#listenercount)
* [listeners](_blessed_borderbox_.borderlayout.md#listeners)
* [off](_blessed_borderbox_.borderlayout.md#off)
* [on](_blessed_borderbox_.borderlayout.md#on)
* [onScreenEvent](_blessed_borderbox_.borderlayout.md#onscreenevent)
* [once](_blessed_borderbox_.borderlayout.md#once)
* [onceKey](_blessed_borderbox_.borderlayout.md#oncekey)
* [parseContent](_blessed_borderbox_.borderlayout.md#parsecontent)
* [popLine](_blessed_borderbox_.borderlayout.md#popline)
* [prepend](_blessed_borderbox_.borderlayout.md#prepend)
* [prependListener](_blessed_borderbox_.borderlayout.md#prependlistener)
* [prependOnceListener](_blessed_borderbox_.borderlayout.md#prependoncelistener)
* [pushLine](_blessed_borderbox_.borderlayout.md#pushline)
* [rawListeners](_blessed_borderbox_.borderlayout.md#rawlisteners)
* [remove](_blessed_borderbox_.borderlayout.md#remove)
* [removeAllListeners](_blessed_borderbox_.borderlayout.md#removealllisteners)
* [removeHover](_blessed_borderbox_.borderlayout.md#removehover)
* [removeKey](_blessed_borderbox_.borderlayout.md#removekey)
* [removeLabel](_blessed_borderbox_.borderlayout.md#removelabel)
* [removeListener](_blessed_borderbox_.borderlayout.md#removelistener)
* [removeScreenEvent](_blessed_borderbox_.borderlayout.md#removescreenevent)
* [render](_blessed_borderbox_.borderlayout.md#render)
* [renderer](_blessed_borderbox_.borderlayout.md#renderer)
* [sattr](_blessed_borderbox_.borderlayout.md#sattr)
* [screenshot](_blessed_borderbox_.borderlayout.md#screenshot)
* [set](_blessed_borderbox_.borderlayout.md#set)
* [setBack](_blessed_borderbox_.borderlayout.md#setback)
* [setBaseLine](_blessed_borderbox_.borderlayout.md#setbaseline)
* [setContent](_blessed_borderbox_.borderlayout.md#setcontent)
* [setFront](_blessed_borderbox_.borderlayout.md#setfront)
* [setHover](_blessed_borderbox_.borderlayout.md#sethover)
* [setIndex](_blessed_borderbox_.borderlayout.md#setindex)
* [setLabel](_blessed_borderbox_.borderlayout.md#setlabel)
* [setLine](_blessed_borderbox_.borderlayout.md#setline)
* [setMaxListeners](_blessed_borderbox_.borderlayout.md#setmaxlisteners)
* [setText](_blessed_borderbox_.borderlayout.md#settext)
* [shiftLine](_blessed_borderbox_.borderlayout.md#shiftline)
* [show](_blessed_borderbox_.borderlayout.md#show)
* [strWidth](_blessed_borderbox_.borderlayout.md#strwidth)
* [toggle](_blessed_borderbox_.borderlayout.md#toggle)
* [unkey](_blessed_borderbox_.borderlayout.md#unkey)
* [unshiftLine](_blessed_borderbox_.borderlayout.md#unshiftline)
* [listenerCount](_blessed_borderbox_.borderlayout.md#static-listenercount)

## Constructors

###  constructor

\+ **new BorderLayout**(`options`: [BorderLayoutOptions](../interfaces/_blessed_borderbox_.borderlayoutoptions.md)): *[BorderLayout](_blessed_borderbox_.borderlayout.md)*

*Overrides [LayoutElement](_declarations_blessed_d_.widgets.layoutelement.md).[constructor](_declarations_blessed_d_.widgets.layoutelement.md#constructor)*

*Defined in [blessed/borderBox.ts:105](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L105)*

**Parameters:**

Name | Type | Default |
------ | ------ | ------ |
`options` | [BorderLayoutOptions](../interfaces/_blessed_borderbox_.borderlayoutoptions.md) |  BorderBox.defaultOptions as any |

**Returns:** *[BorderLayout](_blessed_borderbox_.borderlayout.md)*
...
Setting this property will cause the element to change element's [position](_blessed_borderbox_.borderlayout.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_blessed_borderbox_.borderlayout.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_blessed_borderbox_.borderlayout.md#hide) event.
...
*Defined in [blessed/borderBox.ts:113](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L113)*
...
Put the element in front of its siblings. Uses [setIndex](_blessed_borderbox_.borderlayout.md#setindex)
