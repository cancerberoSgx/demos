[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [widget](../modules/_declarations_blessed_d_.widget.md) › [Message](_declarations_blessed_d_.widget.message.md)
...
## Hierarchy
  ...
  ↳ [MessageElement](_declarations_blessed_d_.widgets.messageelement.md)
...
* [constructor](_declarations_blessed_d_.widget.message.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widget.message.md#$)
* [_](_declarations_blessed_d_.widget.message.md#_)
* [_label](_declarations_blessed_d_.widget.message.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widget.message.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widget.message.md#abottom)
* [aleft](_declarations_blessed_d_.widget.message.md#aleft)
* [aright](_declarations_blessed_d_.widget.message.md#aright)
* [atop](_declarations_blessed_d_.widget.message.md#atop)
* [bg](_declarations_blessed_d_.widget.message.md#bg)
* [bold](_declarations_blessed_d_.widget.message.md#bold)
* [border](_declarations_blessed_d_.widget.message.md#border)
* [bottom](_declarations_blessed_d_.widget.message.md#bottom)
* [childBase](_declarations_blessed_d_.widget.message.md#childbase)
* [childOffset](_declarations_blessed_d_.widget.message.md#childoffset)
* [children](_declarations_blessed_d_.widget.message.md#children)
* [content](_declarations_blessed_d_.widget.message.md#content)
* [data](_declarations_blessed_d_.widget.message.md#data)
* [detached](_declarations_blessed_d_.widget.message.md#detached)
* [draggable](_declarations_blessed_d_.widget.message.md#draggable)
* [fg](_declarations_blessed_d_.widget.message.md#fg)
* [focusable](_declarations_blessed_d_.widget.message.md#focusable)
* [height](_declarations_blessed_d_.widget.message.md#height)
* [hidden](_declarations_blessed_d_.widget.message.md#hidden)
* [iheight](_declarations_blessed_d_.widget.message.md#iheight)
* [ileft](_declarations_blessed_d_.widget.message.md#ileft)
* [index](_declarations_blessed_d_.widget.message.md#index)
* [itop](_declarations_blessed_d_.widget.message.md#itop)
* [iwidth](_declarations_blessed_d_.widget.message.md#iwidth)
* [left](_declarations_blessed_d_.widget.message.md#left)
* [lpos](_declarations_blessed_d_.widget.message.md#lpos)
* [name](_declarations_blessed_d_.widget.message.md#name)
* [options](_declarations_blessed_d_.widget.message.md#options)
* [padding](_declarations_blessed_d_.widget.message.md#padding)
* [parent](_declarations_blessed_d_.widget.message.md#optional-parent)
* [position](_declarations_blessed_d_.widget.message.md#position)
* [rbottom](_declarations_blessed_d_.widget.message.md#rbottom)
* [right](_declarations_blessed_d_.widget.message.md#right)
* [rleft](_declarations_blessed_d_.widget.message.md#rleft)
* [rright](_declarations_blessed_d_.widget.message.md#rright)
* [rtop](_declarations_blessed_d_.widget.message.md#rtop)
* [screen](_declarations_blessed_d_.widget.message.md#screen)
* [shrink](_declarations_blessed_d_.widget.message.md#shrink)
* [style](_declarations_blessed_d_.widget.message.md#style)
* [top](_declarations_blessed_d_.widget.message.md#top)
* [tpadding](_declarations_blessed_d_.widget.message.md#tpadding)
* [type](_declarations_blessed_d_.widget.message.md#type)
* [uid](_declarations_blessed_d_.widget.message.md#uid)
* [underline](_declarations_blessed_d_.widget.message.md#underline)
* [visible](_declarations_blessed_d_.widget.message.md#visible)
* [width](_declarations_blessed_d_.widget.message.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widget.message.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widget.message.md#_align)
* [_getBottom](_declarations_blessed_d_.widget.message.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widget.message.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widget.message.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widget.message.md#_getleft)
* [_getPos](_declarations_blessed_d_.widget.message.md#_getpos)
* [_getRight](_declarations_blessed_d_.widget.message.md#_getright)
* [_getShrink](_declarations_blessed_d_.widget.message.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widget.message.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widget.message.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widget.message.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widget.message.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widget.message.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widget.message.md#_wrapcontent)
* [addListener](_declarations_blessed_d_.widget.message.md#addlistener)
* [append](_declarations_blessed_d_.widget.message.md#append)
* [clearBaseLine](_declarations_blessed_d_.widget.message.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widget.message.md#clearline)
* [clearPos](_declarations_blessed_d_.widget.message.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widget.message.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widget.message.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widget.message.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widget.message.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widget.message.md#deletetop)
* [destroy](_declarations_blessed_d_.widget.message.md#destroy)
* [detach](_declarations_blessed_d_.widget.message.md#detach)
* [disableDrag](_declarations_blessed_d_.widget.message.md#disabledrag)
* [display](_declarations_blessed_d_.widget.message.md#display)
* [emit](_declarations_blessed_d_.widget.message.md#emit)
* [emitAncestors](_declarations_blessed_d_.widget.message.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widget.message.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widget.message.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widget.message.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widget.message.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widget.message.md#enablemouse)
* [error](_declarations_blessed_d_.widget.message.md#error)
* [eventNames](_declarations_blessed_d_.widget.message.md#eventnames)
* [focus](_declarations_blessed_d_.widget.message.md#focus)
* [forAncestors](_declarations_blessed_d_.widget.message.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widget.message.md#fordescendants)
* [free](_declarations_blessed_d_.widget.message.md#free)
* [get](_declarations_blessed_d_.widget.message.md#get)
* [getBaseLine](_declarations_blessed_d_.widget.message.md#getbaseline)
* [getContent](_declarations_blessed_d_.widget.message.md#getcontent)
* [getLine](_declarations_blessed_d_.widget.message.md#getline)
* [getLines](_declarations_blessed_d_.widget.message.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widget.message.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widget.message.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widget.message.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widget.message.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widget.message.md#getscrollperc)
* [getText](_declarations_blessed_d_.widget.message.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widget.message.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widget.message.md#hasdescendant)
* [hide](_declarations_blessed_d_.widget.message.md#hide)
* [insert](_declarations_blessed_d_.widget.message.md#insert)
* [insertAfter](_declarations_blessed_d_.widget.message.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widget.message.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widget.message.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widget.message.md#insertline)
* [insertTop](_declarations_blessed_d_.widget.message.md#inserttop)
* [key](_declarations_blessed_d_.widget.message.md#key)
* [kill](_declarations_blessed_d_.widget.message.md#kill)
* [listenerCount](_declarations_blessed_d_.widget.message.md#listenercount)
* [listeners](_declarations_blessed_d_.widget.message.md#listeners)
* [log](_declarations_blessed_d_.widget.message.md#log)
* [off](_declarations_blessed_d_.widget.message.md#off)
* [on](_declarations_blessed_d_.widget.message.md#on)
* [onScreenEvent](_declarations_blessed_d_.widget.message.md#onscreenevent)
* [once](_declarations_blessed_d_.widget.message.md#once)
* [onceKey](_declarations_blessed_d_.widget.message.md#oncekey)
* [parseContent](_declarations_blessed_d_.widget.message.md#parsecontent)
* [popLine](_declarations_blessed_d_.widget.message.md#popline)
* [prepend](_declarations_blessed_d_.widget.message.md#prepend)
* [prependListener](_declarations_blessed_d_.widget.message.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widget.message.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widget.message.md#pushline)
* [rawListeners](_declarations_blessed_d_.widget.message.md#rawlisteners)
* [remove](_declarations_blessed_d_.widget.message.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widget.message.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widget.message.md#removehover)
* [removeKey](_declarations_blessed_d_.widget.message.md#removekey)
* [removeLabel](_declarations_blessed_d_.widget.message.md#removelabel)
* [removeListener](_declarations_blessed_d_.widget.message.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widget.message.md#removescreenevent)
* [render](_declarations_blessed_d_.widget.message.md#render)
* [resetScroll](_declarations_blessed_d_.widget.message.md#resetscroll)
* [sattr](_declarations_blessed_d_.widget.message.md#sattr)
* [screenshot](_declarations_blessed_d_.widget.message.md#screenshot)
* [scroll](_declarations_blessed_d_.widget.message.md#scroll)
* [scrollTo](_declarations_blessed_d_.widget.message.md#scrollto)
* [set](_declarations_blessed_d_.widget.message.md#set)
* [setBack](_declarations_blessed_d_.widget.message.md#setback)
* [setBaseLine](_declarations_blessed_d_.widget.message.md#setbaseline)
* [setContent](_declarations_blessed_d_.widget.message.md#setcontent)
* [setFront](_declarations_blessed_d_.widget.message.md#setfront)
* [setHover](_declarations_blessed_d_.widget.message.md#sethover)
* [setIndex](_declarations_blessed_d_.widget.message.md#setindex)
* [setLabel](_declarations_blessed_d_.widget.message.md#setlabel)
* [setLine](_declarations_blessed_d_.widget.message.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widget.message.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widget.message.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widget.message.md#setscrollperc)
* [setText](_declarations_blessed_d_.widget.message.md#settext)
* [shiftLine](_declarations_blessed_d_.widget.message.md#shiftline)
* [show](_declarations_blessed_d_.widget.message.md#show)
* [strWidth](_declarations_blessed_d_.widget.message.md#strwidth)
* [toggle](_declarations_blessed_d_.widget.message.md#toggle)
* [unkey](_declarations_blessed_d_.widget.message.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widget.message.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widget.message.md#static-listenercount)

## Constructors

###  constructor

\+ **new Message**(`opts`: [MessageOptions](../interfaces/_declarations_blessed_d_.widgets.messageoptions.md)): *[Message](_declarations_blessed_d_.widget.message.md)*

*Inherited from [MessageElement](_declarations_blessed_d_.widgets.messageelement.md).[constructor](_declarations_blessed_d_.widgets.messageelement.md#constructor)*
...
**Returns:** *[Message](_declarations_blessed_d_.widget.message.md)*
...
*Inherited from [MessageElement](_declarations_blessed_d_.widgets.messageelement.md).[options](_declarations_blessed_d_.widgets.messageelement.md#options)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widget.message.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widget.message.md#_getcoords) |
...
*Inherited from [MessageElement](_declarations_blessed_d_.widgets.messageelement.md).[display](_declarations_blessed_d_.widgets.messageelement.md#display)*
...
*Inherited from [MessageElement](_declarations_blessed_d_.widgets.messageelement.md).[error](_declarations_blessed_d_.widgets.messageelement.md#error)*
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widget.message.md#hide) event.
...
*Inherited from [MessageElement](_declarations_blessed_d_.widgets.messageelement.md).[log](_declarations_blessed_d_.widgets.messageelement.md#log)*
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widget.message.md#setindex)
