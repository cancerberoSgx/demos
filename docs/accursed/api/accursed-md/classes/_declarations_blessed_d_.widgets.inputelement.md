[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [Widgets](../modules/_declarations_blessed_d_.widgets.md) › [InputElement](_declarations_blessed_d_.widgets.inputelement.md)

# Class: InputElement <**Options**>
...
## Hierarchy
  ...
  ↳ [ButtonElement](_declarations_blessed_d_.widgets.buttonelement.md)
  ...
  ↳ [Input](_declarations_blessed_d_.widget.input.md)
...
* [constructor](_declarations_blessed_d_.widgets.inputelement.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widgets.inputelement.md#$)
* [_](_declarations_blessed_d_.widgets.inputelement.md#_)
* [_label](_declarations_blessed_d_.widgets.inputelement.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widgets.inputelement.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widgets.inputelement.md#abottom)
* [aleft](_declarations_blessed_d_.widgets.inputelement.md#aleft)
* [aright](_declarations_blessed_d_.widgets.inputelement.md#aright)
* [atop](_declarations_blessed_d_.widgets.inputelement.md#atop)
* [bg](_declarations_blessed_d_.widgets.inputelement.md#bg)
* [bold](_declarations_blessed_d_.widgets.inputelement.md#bold)
* [border](_declarations_blessed_d_.widgets.inputelement.md#border)
* [bottom](_declarations_blessed_d_.widgets.inputelement.md#bottom)
* [childBase](_declarations_blessed_d_.widgets.inputelement.md#childbase)
* [childOffset](_declarations_blessed_d_.widgets.inputelement.md#childoffset)
* [children](_declarations_blessed_d_.widgets.inputelement.md#children)
* [content](_declarations_blessed_d_.widgets.inputelement.md#content)
* [data](_declarations_blessed_d_.widgets.inputelement.md#data)
* [detached](_declarations_blessed_d_.widgets.inputelement.md#detached)
* [draggable](_declarations_blessed_d_.widgets.inputelement.md#draggable)
* [fg](_declarations_blessed_d_.widgets.inputelement.md#fg)
* [focusable](_declarations_blessed_d_.widgets.inputelement.md#focusable)
* [height](_declarations_blessed_d_.widgets.inputelement.md#height)
* [hidden](_declarations_blessed_d_.widgets.inputelement.md#hidden)
* [iheight](_declarations_blessed_d_.widgets.inputelement.md#iheight)
* [ileft](_declarations_blessed_d_.widgets.inputelement.md#ileft)
* [index](_declarations_blessed_d_.widgets.inputelement.md#index)
* [itop](_declarations_blessed_d_.widgets.inputelement.md#itop)
* [iwidth](_declarations_blessed_d_.widgets.inputelement.md#iwidth)
* [left](_declarations_blessed_d_.widgets.inputelement.md#left)
* [lpos](_declarations_blessed_d_.widgets.inputelement.md#lpos)
* [name](_declarations_blessed_d_.widgets.inputelement.md#name)
* [options](_declarations_blessed_d_.widgets.inputelement.md#options)
* [padding](_declarations_blessed_d_.widgets.inputelement.md#padding)
* [parent](_declarations_blessed_d_.widgets.inputelement.md#optional-parent)
* [position](_declarations_blessed_d_.widgets.inputelement.md#position)
* [rbottom](_declarations_blessed_d_.widgets.inputelement.md#rbottom)
* [right](_declarations_blessed_d_.widgets.inputelement.md#right)
* [rleft](_declarations_blessed_d_.widgets.inputelement.md#rleft)
* [rright](_declarations_blessed_d_.widgets.inputelement.md#rright)
* [rtop](_declarations_blessed_d_.widgets.inputelement.md#rtop)
* [screen](_declarations_blessed_d_.widgets.inputelement.md#screen)
* [shrink](_declarations_blessed_d_.widgets.inputelement.md#shrink)
* [style](_declarations_blessed_d_.widgets.inputelement.md#style)
* [top](_declarations_blessed_d_.widgets.inputelement.md#top)
* [tpadding](_declarations_blessed_d_.widgets.inputelement.md#tpadding)
* [type](_declarations_blessed_d_.widgets.inputelement.md#type)
* [uid](_declarations_blessed_d_.widgets.inputelement.md#uid)
* [underline](_declarations_blessed_d_.widgets.inputelement.md#underline)
* [visible](_declarations_blessed_d_.widgets.inputelement.md#visible)
* [width](_declarations_blessed_d_.widgets.inputelement.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widgets.inputelement.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widgets.inputelement.md#_align)
* [_getBottom](_declarations_blessed_d_.widgets.inputelement.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widgets.inputelement.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widgets.inputelement.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widgets.inputelement.md#_getleft)
* [_getPos](_declarations_blessed_d_.widgets.inputelement.md#_getpos)
* [_getRight](_declarations_blessed_d_.widgets.inputelement.md#_getright)
* [_getShrink](_declarations_blessed_d_.widgets.inputelement.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widgets.inputelement.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widgets.inputelement.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widgets.inputelement.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widgets.inputelement.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widgets.inputelement.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widgets.inputelement.md#_wrapcontent)
* [addListener](_declarations_blessed_d_.widgets.inputelement.md#addlistener)
* [append](_declarations_blessed_d_.widgets.inputelement.md#append)
* [clearBaseLine](_declarations_blessed_d_.widgets.inputelement.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widgets.inputelement.md#clearline)
* [clearPos](_declarations_blessed_d_.widgets.inputelement.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widgets.inputelement.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widgets.inputelement.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widgets.inputelement.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widgets.inputelement.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widgets.inputelement.md#deletetop)
* [destroy](_declarations_blessed_d_.widgets.inputelement.md#destroy)
* [detach](_declarations_blessed_d_.widgets.inputelement.md#detach)
* [disableDrag](_declarations_blessed_d_.widgets.inputelement.md#disabledrag)
* [emit](_declarations_blessed_d_.widgets.inputelement.md#emit)
* [emitAncestors](_declarations_blessed_d_.widgets.inputelement.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widgets.inputelement.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widgets.inputelement.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widgets.inputelement.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widgets.inputelement.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widgets.inputelement.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widgets.inputelement.md#eventnames)
* [focus](_declarations_blessed_d_.widgets.inputelement.md#focus)
* [forAncestors](_declarations_blessed_d_.widgets.inputelement.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widgets.inputelement.md#fordescendants)
* [free](_declarations_blessed_d_.widgets.inputelement.md#free)
* [get](_declarations_blessed_d_.widgets.inputelement.md#get)
* [getBaseLine](_declarations_blessed_d_.widgets.inputelement.md#getbaseline)
* [getContent](_declarations_blessed_d_.widgets.inputelement.md#getcontent)
* [getLine](_declarations_blessed_d_.widgets.inputelement.md#getline)
* [getLines](_declarations_blessed_d_.widgets.inputelement.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widgets.inputelement.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widgets.inputelement.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widgets.inputelement.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widgets.inputelement.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widgets.inputelement.md#getscrollperc)
* [getText](_declarations_blessed_d_.widgets.inputelement.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widgets.inputelement.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widgets.inputelement.md#hasdescendant)
* [hide](_declarations_blessed_d_.widgets.inputelement.md#hide)
* [insert](_declarations_blessed_d_.widgets.inputelement.md#insert)
* [insertAfter](_declarations_blessed_d_.widgets.inputelement.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widgets.inputelement.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widgets.inputelement.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widgets.inputelement.md#insertline)
* [insertTop](_declarations_blessed_d_.widgets.inputelement.md#inserttop)
* [key](_declarations_blessed_d_.widgets.inputelement.md#key)
* [kill](_declarations_blessed_d_.widgets.inputelement.md#kill)
* [listenerCount](_declarations_blessed_d_.widgets.inputelement.md#listenercount)
* [listeners](_declarations_blessed_d_.widgets.inputelement.md#listeners)
* [off](_declarations_blessed_d_.widgets.inputelement.md#off)
* [on](_declarations_blessed_d_.widgets.inputelement.md#on)
* [onScreenEvent](_declarations_blessed_d_.widgets.inputelement.md#onscreenevent)
* [once](_declarations_blessed_d_.widgets.inputelement.md#once)
* [onceKey](_declarations_blessed_d_.widgets.inputelement.md#oncekey)
* [parseContent](_declarations_blessed_d_.widgets.inputelement.md#parsecontent)
* [popLine](_declarations_blessed_d_.widgets.inputelement.md#popline)
* [prepend](_declarations_blessed_d_.widgets.inputelement.md#prepend)
* [prependListener](_declarations_blessed_d_.widgets.inputelement.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widgets.inputelement.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widgets.inputelement.md#pushline)
* [rawListeners](_declarations_blessed_d_.widgets.inputelement.md#rawlisteners)
* [remove](_declarations_blessed_d_.widgets.inputelement.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widgets.inputelement.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widgets.inputelement.md#removehover)
* [removeKey](_declarations_blessed_d_.widgets.inputelement.md#removekey)
* [removeLabel](_declarations_blessed_d_.widgets.inputelement.md#removelabel)
* [removeListener](_declarations_blessed_d_.widgets.inputelement.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widgets.inputelement.md#removescreenevent)
* [render](_declarations_blessed_d_.widgets.inputelement.md#render)
* [resetScroll](_declarations_blessed_d_.widgets.inputelement.md#resetscroll)
* [sattr](_declarations_blessed_d_.widgets.inputelement.md#sattr)
* [screenshot](_declarations_blessed_d_.widgets.inputelement.md#screenshot)
* [scroll](_declarations_blessed_d_.widgets.inputelement.md#scroll)
* [scrollTo](_declarations_blessed_d_.widgets.inputelement.md#scrollto)
* [set](_declarations_blessed_d_.widgets.inputelement.md#set)
* [setBack](_declarations_blessed_d_.widgets.inputelement.md#setback)
* [setBaseLine](_declarations_blessed_d_.widgets.inputelement.md#setbaseline)
* [setContent](_declarations_blessed_d_.widgets.inputelement.md#setcontent)
* [setFront](_declarations_blessed_d_.widgets.inputelement.md#setfront)
* [setHover](_declarations_blessed_d_.widgets.inputelement.md#sethover)
* [setIndex](_declarations_blessed_d_.widgets.inputelement.md#setindex)
* [setLabel](_declarations_blessed_d_.widgets.inputelement.md#setlabel)
* [setLine](_declarations_blessed_d_.widgets.inputelement.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widgets.inputelement.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widgets.inputelement.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widgets.inputelement.md#setscrollperc)
* [setText](_declarations_blessed_d_.widgets.inputelement.md#settext)
* [shiftLine](_declarations_blessed_d_.widgets.inputelement.md#shiftline)
* [show](_declarations_blessed_d_.widgets.inputelement.md#show)
* [strWidth](_declarations_blessed_d_.widgets.inputelement.md#strwidth)
* [toggle](_declarations_blessed_d_.widgets.inputelement.md#toggle)
* [unkey](_declarations_blessed_d_.widgets.inputelement.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widgets.inputelement.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widgets.inputelement.md#static-listenercount)

## Constructors

###  constructor

\+ **new InputElement**(`opts`: [InputOptions](../interfaces/_declarations_blessed_d_.widgets.inputoptions.md)): *[InputElement](_declarations_blessed_d_.widgets.inputelement.md)*
...
*Defined in [declarations/blessed.d.ts:2738](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L2738)*

**Parameters:**

Name | Type |
------ | ------ |
`opts` | [InputOptions](../interfaces/_declarations_blessed_d_.widgets.inputoptions.md) |

**Returns:** *[InputElement](_declarations_blessed_d_.widgets.inputelement.md)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widgets.inputelement.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widgets.inputelement.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widgets.inputelement.md#hide) event.
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widgets.inputelement.md#setindex)
