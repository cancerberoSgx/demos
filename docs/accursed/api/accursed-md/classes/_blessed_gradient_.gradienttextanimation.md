[accursed](../README.md) > ["blessed/gradient"](../modules/_blessed_gradient_.md) > [GradientTextAnimation](../classes/_blessed_gradient_.gradienttextanimation.md)
...
* [$](_blessed_gradient_.gradienttextanimation.md#_)
* [_](_blessed_gradient_.gradienttextanimation.md#_-1)
* [_label](_blessed_gradient_.gradienttextanimation.md#_label)
* [_noFill](_blessed_gradient_.gradienttextanimation.md#_nofill)
...
* [bgGradientColors](_blessed_gradient_.gradienttextanimation.md#bggradientcolors)
...
* [fgGradientColors](_blessed_gradient_.gradienttextanimation.md#fggradientcolors)
...
* [parent](_blessed_gradient_.gradienttextanimation.md#parent)
...
* [defaultMaxListeners](_blessed_gradient_.gradienttextanimation.md#defaultmaxlisteners)
...
* [getBgGradientColors](_blessed_gradient_.gradienttextanimation.md#getbggradientcolors)
* [getColorInputFormat](_blessed_gradient_.gradienttextanimation.md#getcolorinputformat)
* [getContent](_blessed_gradient_.gradienttextanimation.md#getcontent)
* [getFgGradientColors](_blessed_gradient_.gradienttextanimation.md#getfggradientcolors)
...
* [startAnimation](_blessed_gradient_.gradienttextanimation.md#startanimation)
* [stopAnimation](_blessed_gradient_.gradienttextanimation.md#stopanimation)
...
* [listenerCount](_blessed_gradient_.gradienttextanimation.md#listenercount-1)
...
*Defined in [blessed/gradient.ts:88](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/gradient.ts#L88)*
...
*Inherited from [GradientText](_blessed_gradient_.gradienttext.md).[bgGradientColors](_blessed_gradient_.gradienttext.md#bggradientcolors)*
...
*Inherited from [GradientText](_blessed_gradient_.gradienttext.md).[fgGradientColors](_blessed_gradient_.gradienttext.md#fggradientcolors)*
...
*Defined in [blessed/gradient.ts:87](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/gradient.ts#L87)*
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `Optional` get | `boolean` |  it's passed to [\_getCoords](_blessed_gradient_.gradienttextanimation.md#_getcoords) |
...
*Inherited from [GradientText](_blessed_gradient_.gradienttext.md).[getBgGradientColors](_blessed_gradient_.gradienttext.md#getbggradientcolors)*
...
*Inherited from [GradientText](_blessed_gradient_.gradienttext.md).[getColorInputFormat](_blessed_gradient_.gradienttext.md#getcolorinputformat)*
...
*Inherited from [GradientText](_blessed_gradient_.gradienttext.md).[getFgGradientColors](_blessed_gradient_.gradienttext.md#getfggradientcolors)*
...
___
<a id="startanimation"></a>

### `<Protected>` startAnimation

▸ **startAnimation**(): `void`

*Defined in [blessed/gradient.ts:103](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/gradient.ts#L103)*
...
*Defined in [blessed/gradient.ts:99](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/gradient.ts#L99)*
