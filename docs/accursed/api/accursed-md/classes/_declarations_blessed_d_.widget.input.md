[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [widget](../modules/_declarations_blessed_d_.widget.md) › [Input](_declarations_blessed_d_.widget.input.md)
...
* [constructor](_declarations_blessed_d_.widget.input.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widget.input.md#$)
* [_](_declarations_blessed_d_.widget.input.md#_)
* [_label](_declarations_blessed_d_.widget.input.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widget.input.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widget.input.md#abottom)
* [aleft](_declarations_blessed_d_.widget.input.md#aleft)
* [aright](_declarations_blessed_d_.widget.input.md#aright)
* [atop](_declarations_blessed_d_.widget.input.md#atop)
* [bg](_declarations_blessed_d_.widget.input.md#bg)
* [bold](_declarations_blessed_d_.widget.input.md#bold)
* [border](_declarations_blessed_d_.widget.input.md#border)
* [bottom](_declarations_blessed_d_.widget.input.md#bottom)
* [childBase](_declarations_blessed_d_.widget.input.md#childbase)
* [childOffset](_declarations_blessed_d_.widget.input.md#childoffset)
* [children](_declarations_blessed_d_.widget.input.md#children)
* [content](_declarations_blessed_d_.widget.input.md#content)
* [data](_declarations_blessed_d_.widget.input.md#data)
* [detached](_declarations_blessed_d_.widget.input.md#detached)
* [draggable](_declarations_blessed_d_.widget.input.md#draggable)
* [fg](_declarations_blessed_d_.widget.input.md#fg)
* [focusable](_declarations_blessed_d_.widget.input.md#focusable)
* [height](_declarations_blessed_d_.widget.input.md#height)
* [hidden](_declarations_blessed_d_.widget.input.md#hidden)
* [iheight](_declarations_blessed_d_.widget.input.md#iheight)
* [ileft](_declarations_blessed_d_.widget.input.md#ileft)
* [index](_declarations_blessed_d_.widget.input.md#index)
* [itop](_declarations_blessed_d_.widget.input.md#itop)
* [iwidth](_declarations_blessed_d_.widget.input.md#iwidth)
* [left](_declarations_blessed_d_.widget.input.md#left)
* [lpos](_declarations_blessed_d_.widget.input.md#lpos)
* [name](_declarations_blessed_d_.widget.input.md#name)
* [options](_declarations_blessed_d_.widget.input.md#options)
* [padding](_declarations_blessed_d_.widget.input.md#padding)
* [parent](_declarations_blessed_d_.widget.input.md#optional-parent)
* [position](_declarations_blessed_d_.widget.input.md#position)
* [rbottom](_declarations_blessed_d_.widget.input.md#rbottom)
* [right](_declarations_blessed_d_.widget.input.md#right)
* [rleft](_declarations_blessed_d_.widget.input.md#rleft)
* [rright](_declarations_blessed_d_.widget.input.md#rright)
* [rtop](_declarations_blessed_d_.widget.input.md#rtop)
* [screen](_declarations_blessed_d_.widget.input.md#screen)
* [shrink](_declarations_blessed_d_.widget.input.md#shrink)
* [style](_declarations_blessed_d_.widget.input.md#style)
* [top](_declarations_blessed_d_.widget.input.md#top)
* [tpadding](_declarations_blessed_d_.widget.input.md#tpadding)
* [type](_declarations_blessed_d_.widget.input.md#type)
* [uid](_declarations_blessed_d_.widget.input.md#uid)
* [underline](_declarations_blessed_d_.widget.input.md#underline)
* [visible](_declarations_blessed_d_.widget.input.md#visible)
* [width](_declarations_blessed_d_.widget.input.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widget.input.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widget.input.md#_align)
* [_getBottom](_declarations_blessed_d_.widget.input.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widget.input.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widget.input.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widget.input.md#_getleft)
* [_getPos](_declarations_blessed_d_.widget.input.md#_getpos)
* [_getRight](_declarations_blessed_d_.widget.input.md#_getright)
* [_getShrink](_declarations_blessed_d_.widget.input.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widget.input.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widget.input.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widget.input.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widget.input.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widget.input.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widget.input.md#_wrapcontent)
* [addListener](_declarations_blessed_d_.widget.input.md#addlistener)
* [append](_declarations_blessed_d_.widget.input.md#append)
* [clearBaseLine](_declarations_blessed_d_.widget.input.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widget.input.md#clearline)
* [clearPos](_declarations_blessed_d_.widget.input.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widget.input.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widget.input.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widget.input.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widget.input.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widget.input.md#deletetop)
* [destroy](_declarations_blessed_d_.widget.input.md#destroy)
* [detach](_declarations_blessed_d_.widget.input.md#detach)
* [disableDrag](_declarations_blessed_d_.widget.input.md#disabledrag)
* [emit](_declarations_blessed_d_.widget.input.md#emit)
* [emitAncestors](_declarations_blessed_d_.widget.input.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widget.input.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widget.input.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widget.input.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widget.input.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widget.input.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widget.input.md#eventnames)
* [focus](_declarations_blessed_d_.widget.input.md#focus)
* [forAncestors](_declarations_blessed_d_.widget.input.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widget.input.md#fordescendants)
* [free](_declarations_blessed_d_.widget.input.md#free)
* [get](_declarations_blessed_d_.widget.input.md#get)
* [getBaseLine](_declarations_blessed_d_.widget.input.md#getbaseline)
* [getContent](_declarations_blessed_d_.widget.input.md#getcontent)
* [getLine](_declarations_blessed_d_.widget.input.md#getline)
* [getLines](_declarations_blessed_d_.widget.input.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widget.input.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widget.input.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widget.input.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widget.input.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widget.input.md#getscrollperc)
* [getText](_declarations_blessed_d_.widget.input.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widget.input.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widget.input.md#hasdescendant)
* [hide](_declarations_blessed_d_.widget.input.md#hide)
* [insert](_declarations_blessed_d_.widget.input.md#insert)
* [insertAfter](_declarations_blessed_d_.widget.input.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widget.input.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widget.input.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widget.input.md#insertline)
* [insertTop](_declarations_blessed_d_.widget.input.md#inserttop)
* [key](_declarations_blessed_d_.widget.input.md#key)
* [kill](_declarations_blessed_d_.widget.input.md#kill)
* [listenerCount](_declarations_blessed_d_.widget.input.md#listenercount)
* [listeners](_declarations_blessed_d_.widget.input.md#listeners)
* [off](_declarations_blessed_d_.widget.input.md#off)
* [on](_declarations_blessed_d_.widget.input.md#on)
* [onScreenEvent](_declarations_blessed_d_.widget.input.md#onscreenevent)
* [once](_declarations_blessed_d_.widget.input.md#once)
* [onceKey](_declarations_blessed_d_.widget.input.md#oncekey)
* [parseContent](_declarations_blessed_d_.widget.input.md#parsecontent)
* [popLine](_declarations_blessed_d_.widget.input.md#popline)
* [prepend](_declarations_blessed_d_.widget.input.md#prepend)
* [prependListener](_declarations_blessed_d_.widget.input.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widget.input.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widget.input.md#pushline)
* [rawListeners](_declarations_blessed_d_.widget.input.md#rawlisteners)
* [remove](_declarations_blessed_d_.widget.input.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widget.input.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widget.input.md#removehover)
* [removeKey](_declarations_blessed_d_.widget.input.md#removekey)
* [removeLabel](_declarations_blessed_d_.widget.input.md#removelabel)
* [removeListener](_declarations_blessed_d_.widget.input.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widget.input.md#removescreenevent)
* [render](_declarations_blessed_d_.widget.input.md#render)
* [resetScroll](_declarations_blessed_d_.widget.input.md#resetscroll)
* [sattr](_declarations_blessed_d_.widget.input.md#sattr)
* [screenshot](_declarations_blessed_d_.widget.input.md#screenshot)
* [scroll](_declarations_blessed_d_.widget.input.md#scroll)
* [scrollTo](_declarations_blessed_d_.widget.input.md#scrollto)
* [set](_declarations_blessed_d_.widget.input.md#set)
* [setBack](_declarations_blessed_d_.widget.input.md#setback)
* [setBaseLine](_declarations_blessed_d_.widget.input.md#setbaseline)
* [setContent](_declarations_blessed_d_.widget.input.md#setcontent)
* [setFront](_declarations_blessed_d_.widget.input.md#setfront)
* [setHover](_declarations_blessed_d_.widget.input.md#sethover)
* [setIndex](_declarations_blessed_d_.widget.input.md#setindex)
* [setLabel](_declarations_blessed_d_.widget.input.md#setlabel)
* [setLine](_declarations_blessed_d_.widget.input.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widget.input.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widget.input.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widget.input.md#setscrollperc)
* [setText](_declarations_blessed_d_.widget.input.md#settext)
* [shiftLine](_declarations_blessed_d_.widget.input.md#shiftline)
* [show](_declarations_blessed_d_.widget.input.md#show)
* [strWidth](_declarations_blessed_d_.widget.input.md#strwidth)
* [toggle](_declarations_blessed_d_.widget.input.md#toggle)
* [unkey](_declarations_blessed_d_.widget.input.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widget.input.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widget.input.md#static-listenercount)

## Constructors

###  constructor

\+ **new Input**(`opts`: [InputOptions](../interfaces/_declarations_blessed_d_.widgets.inputoptions.md)): *[Input](_declarations_blessed_d_.widget.input.md)*

*Inherited from [InputElement](_declarations_blessed_d_.widgets.inputelement.md).[constructor](_declarations_blessed_d_.widgets.inputelement.md#constructor)*
...
**Returns:** *[Input](_declarations_blessed_d_.widget.input.md)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widget.input.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widget.input.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widget.input.md#hide) event.
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widget.input.md#setindex)
