[accursed](../README.md) > ["declarations/blessed-contrib.d"](../modules/_declarations_blessed_contrib_d_.md) > [BlessedContrib](../modules/_declarations_blessed_contrib_d_.blessedcontrib.md) > [widget](../modules/_declarations_blessed_contrib_d_.blessedcontrib.widget.md) > [Log](../classes/_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md)
...
* [constructor](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#constructor)

### Properties

* [$](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_)
* [_](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_-1)
* [_label](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_label)
* [_noFill](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_nofill)
* [abottom](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#abottom)
* [aleft](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#aleft)
* [aright](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#aright)
* [atop](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#atop)
* [bg](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#bg)
* [bold](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#bold)
* [border](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#border)
* [bottom](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#bottom)
* [childBase](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#childbase)
* [childOffset](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#childoffset)
* [children](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#children)
* [content](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#content)
* [data](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#data)
* [detached](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#detached)
* [draggable](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#draggable)
* [fg](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#fg)
* [focusable](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#focusable)
* [height](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#height)
* [hidden](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#hidden)
* [iheight](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#iheight)
* [ileft](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#ileft)
* [index](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#index)
* [items](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#items)
* [itop](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#itop)
* [iwidth](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#iwidth)
* [left](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#left)
* [lpos](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#lpos)
* [name](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#name)
* [options](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#options)
* [padding](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#padding)
* [parent](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#parent)
* [position](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#position)
* [rbottom](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#rbottom)
* [right](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#right)
* [ritems](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#ritems)
* [rleft](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#rleft)
* [rright](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#rright)
* [rtop](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#rtop)
* [screen](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#screen)
* [selected](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#selected)
* [shrink](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#shrink)
* [style](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#style)
* [top](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#top)
* [tpadding](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#tpadding)
* [type](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#type)
* [uid](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#uid)
* [underline](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#underline)
* [value](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#value)
* [visible](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#visible)
* [width](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#width)
* [defaultMaxListeners](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_align)
* [_getBottom](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getbottom)
* [_getCoords](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getcoords)
* [_getHeight](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getheight)
* [_getLeft](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getleft)
* [_getPos](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getpos)
* [_getRight](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getright)
* [_getShrink](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getshrinkbox)
* [_getTop](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_gettop)
* [_getWidth](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getwidth)
* [_parseAttr](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_parseattr)
* [_parseTags](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_parsetags)
* [_wrapContent](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_wrapcontent)
* [add](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#add)
* [addItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#additem)
* [addListener](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#addlistener)
* [append](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#append)
* [clearBaseLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#clearbaseline)
* [clearItems](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#clearitems)
* [clearLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#clearline)
* [clearPos](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#clearpos)
* [collectAncestors](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#collectancestors)
* [collectDescendants](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#collectdescendants)
* [deleteBottom](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#deletebottom)
* [deleteLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#deleteline)
* [deleteTop](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#deletetop)
* [destroy](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#destroy)
* [detach](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#detach)
* [disableDrag](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#disabledrag)
* [down](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#down)
* [emit](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#emit)
* [emitAncestors](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#emitancestors)
* [emitDescendants](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#emitdescendants)
* [enableDrag](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#enabledrag)
* [enableInput](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#enableinput)
* [enableKeys](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#enablekeys)
* [enableMouse](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#enablemouse)
* [eventNames](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#eventnames)
* [focus](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#focus)
* [forAncestors](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#forancestors)
* [forDescendants](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#fordescendants)
* [free](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#free)
* [fuzzyFind](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#fuzzyfind)
* [get](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#get)
* [getBaseLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getbaseline)
* [getContent](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getcontent)
* [getItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getitem)
* [getItemIndex](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getitemindex)
* [getLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getline)
* [getLines](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getlines)
* [getMaxListeners](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getscreenlines)
* [getScroll](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getscroll)
* [getScrollHeight](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#getscrollperc)
* [getText](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#gettext)
* [hasAncestor](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#hasancestor)
* [hasDescendant](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#hasdescendant)
* [hide](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#hide)
* [insert](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#insert)
* [insertAfter](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#insertafter)
* [insertBefore](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#insertbefore)
* [insertBottom](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#insertbottom)
* [insertItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#insertitem)
* [insertLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#insertline)
* [insertTop](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#inserttop)
* [key](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#key)
* [kill](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#kill)
* [listenerCount](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#listenercount)
* [listeners](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#listeners)
* [log](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#log)
* [move](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#move)
* [off](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#off)
* [on](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#on)
* [onScreenEvent](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#onscreenevent)
* [once](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#once)
* [onceKey](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#oncekey)
* [parseContent](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#parsecontent)
* [pick](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#pick)
* [popItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#popitem)
* [popLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#popline)
* [prepend](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#prepend)
* [prependListener](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#prependlistener)
* [prependOnceListener](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#prependoncelistener)
* [pushItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#pushitem)
* [pushLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#pushline)
* [rawListeners](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#rawlisteners)
* [remove](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#remove)
* [removeAllListeners](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#removealllisteners)
* [removeHover](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#removehover)
* [removeItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#removeitem)
* [removeKey](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#removekey)
* [removeLabel](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#removelabel)
* [removeListener](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#removelistener)
* [removeScreenEvent](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#removescreenevent)
* [render](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#render)
* [resetScroll](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#resetscroll)
* [sattr](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#sattr)
* [screenshot](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#screenshot)
* [scroll](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#scroll)
* [scrollTo](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#scrollto)
* [select](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#select)
* [set](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#set)
* [setBack](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setback)
* [setBaseLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setbaseline)
* [setContent](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setcontent)
* [setFront](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setfront)
* [setHover](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#sethover)
* [setIndex](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setindex)
* [setItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setitem)
* [setItems](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setitems)
* [setLabel](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setlabel)
* [setLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setline)
* [setMaxListeners](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setmaxlisteners)
* [setScroll](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setscroll)
* [setScrollPerc](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setscrollperc)
* [setText](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#settext)
* [shiftItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#shiftitem)
* [shiftLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#shiftline)
* [show](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#show)
* [spliceItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#spliceitem)
* [strWidth](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#strwidth)
* [toggle](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#toggle)
* [unkey](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#unkey)
* [unshiftItem](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#unshiftitem)
* [unshiftLine](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#unshiftline)
* [up](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#up)
* [listenerCount](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#listenercount-1)
...
⊕ **new Log**(opts: *[LogOptions](../interfaces/_declarations_blessed_contrib_d_.blessedcontrib.widgets.logoptions.md)*): [Log](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md)

*Inherited from [LogElement](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md).[constructor](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md#constructor)*
...
**Returns:** [Log](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md)
...
*Inherited from [LogElement](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md).[options](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md#options)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#position) property and emit [move](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#move) event.
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `Optional` get | `boolean` |  it's passed to [\_getCoords](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#_getcoords) |
...
*Inherited from [LogElement](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md).[emit](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md#emit)*
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#hide) event.
...
*Inherited from [LogElement](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md).[log](_declarations_blessed_contrib_d_.blessedcontrib.widgets.logelement.md#log)*
...
Select item based on current offset. See [select](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#select) method
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_contrib_d_.blessedcontrib.widget.log.md#setindex)
