[accursed](../README.md) › [Globals](../globals.md) › ["blessed/borderBox"](../modules/_blessed_borderbox_.md) › [BorderBox](_blessed_borderbox_.borderbox.md)

# Class: BorderBox <**Options**>

Its a [box](../interfaces/_jsx_types_.__global.jsx.intrinsicelements.md#box) that support extra border styles. It will respect element's label by default but this can
be configures with option [BorderBoxOptions.removeLabel](../interfaces/_blessed_borderbox_.borderboxoptions.md#optional-removelabel)
...
* [$](_blessed_borderbox_.borderbox.md#$)
* [_](_blessed_borderbox_.borderbox.md#_)
* [_label](_blessed_borderbox_.borderbox.md#optional-_label)
* [_noFill](_blessed_borderbox_.borderbox.md#optional-_nofill)
...
* [parent](_blessed_borderbox_.borderbox.md#optional-parent)
...
* [defaultMaxListeners](_blessed_borderbox_.borderbox.md#static-defaultmaxlisteners)
...
* [listenerCount](_blessed_borderbox_.borderbox.md#static-listenercount)

### Object literals

* [defaultOptions](_blessed_borderbox_.borderbox.md#static-defaultoptions)
...
*Defined in [blessed/borderBox.ts:31](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L31)*

**Parameters:**

Name | Type | Default |
------ | ------ | ------ |
`options` | [BorderBoxOptions](../interfaces/_blessed_borderbox_.borderboxoptions.md) |  BorderBox.defaultOptions as any |
...
*Defined in [blessed/borderBox.ts:24](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L24)*
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_blessed_borderbox_.borderbox.md#_getcoords) |
...
*Defined in [blessed/borderBox.ts:39](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L39)*
...
*Defined in [blessed/borderBox.ts:48](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L48)*
...
*Defined in [blessed/borderBox.ts:26](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L26)*

###  borderStyle

• **borderStyle**: *[light](../enums/_util_boxes_.borderstyle.md#light)* =  BorderStyle.light

*Defined in [blessed/borderBox.ts:27](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L27)*

###  removeLabel

• **removeLabel**: *false* = false

*Defined in [blessed/borderBox.ts:28](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/blessed/borderBox.ts#L28)*
