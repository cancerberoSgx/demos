[accursed](../README.md) > ["blessed/treeView"](../modules/_blessed_treeview_.md) > [TreeView](../classes/_blessed_treeview_.treeview.md)
...
* [$](_blessed_treeview_.treeview.md#_)
* [_](_blessed_treeview_.treeview.md#_-1)
* [_label](_blessed_treeview_.treeview.md#_label)
* [_noFill](_blessed_treeview_.treeview.md#_nofill)
...
* [currentNode](_blessed_treeview_.treeview.md#currentnode)
...
* [focusedLine](_blessed_treeview_.treeview.md#focusedline)
...
* [nodeLines](_blessed_treeview_.treeview.md#nodelines)
* [options](_blessed_treeview_.treeview.md#options)
* [padding](_blessed_treeview_.treeview.md#padding)
* [parent](_blessed_treeview_.treeview.md#parent)
...
* [rootNodes](_blessed_treeview_.treeview.md#rootnodes)
...
* [selectedNodes](_blessed_treeview_.treeview.md#selectednodes)
...
* [defaultMaxListeners](_blessed_treeview_.treeview.md#defaultmaxlisteners)
...
* [getNodeLines](_blessed_treeview_.treeview.md#getnodelines)
...
* [onClick](_blessed_treeview_.treeview.md#onclick)
* [onKey](_blessed_treeview_.treeview.md#onkey)
...
* [processNodes](_blessed_treeview_.treeview.md#processnodes)
* [processSelect](_blessed_treeview_.treeview.md#processselect)
...
* [listenerCount](_blessed_treeview_.treeview.md#listenercount-1)

### Object literals

* [defaultOptions](_blessed_treeview_.treeview.md#defaultoptions)
...
*Defined in [blessed/treeView.ts:151](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L151)*

**Parameters:**

| Name | Type | Default value |
| ------ | ------ | ------ |
| `Default value` options | [TreeOptions](../interfaces/_blessed_treeview_.treeoptions.md)<`T`> |  TreeView.defaultOptions as any |
...
*Defined in [blessed/treeView.ts:128](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L128)*
...
*Defined in [blessed/treeView.ts:132](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L132)*
...
*Defined in [blessed/treeView.ts:131](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L131)*
...
*Defined in [blessed/treeView.ts:130](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L130)*
...
___
<a id="selectednodes"></a>

### `<Protected>` selectedNodes

**● selectedNodes**: *[Node](../interfaces/_blessed_treeview_.node.md)[]* =  []

*Defined in [blessed/treeView.ts:129](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L129)*
...
*Defined in [blessed/treeView.ts:126](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L126)*
...
*Defined in [blessed/treeView.ts:125](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L125)*
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `Optional` get | `boolean` |  it's passed to [\_getCoords](_blessed_treeview_.treeview.md#_getcoords) |
...
*Defined in [blessed/treeView.ts:412](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L412)*
...
*Defined in [blessed/treeView.ts:437](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L437)*
...
*Defined in [blessed/treeView.ts:522](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L522)*
...
___
<a id="getfocusednode"></a>

###  getFocusedNode

▸ **getFocusedNode**(): [Node](../interfaces/_blessed_treeview_.node.md)

*Defined in [blessed/treeView.ts:500](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L500)*
...
*Defined in [blessed/treeView.ts:466](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L466)*
...
| `Default value` lines | `object`[] |  [] |
| `Default value` height | `number` |  this.height as number |
...
*Defined in [blessed/treeView.ts:507](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L507)*
...
___
<a id="getselectednodes"></a>

###  getSelectedNodes

▸ **getSelectedNodes**(): [Node](../interfaces/_blessed_treeview_.node.md)[]

*Defined in [blessed/treeView.ts:515](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L515)*

Gets the current selected node, or nodes in case option.multipleSelection is enabled, or undefined if there is no selected node
...
*Defined in [blessed/treeView.ts:179](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L179)*
...
*Defined in [blessed/treeView.ts:198](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L198)*
...
*Defined in [blessed/treeView.ts:447](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L447)*
...
___
<a id="processselect"></a>

### `<Protected>` processSelect

▸ **processSelect**(multipleSelectionApplies?: *`boolean`*): `void`

*Defined in [blessed/treeView.ts:257](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L257)*

**Parameters:**

| Name | Type | Default value |
| ------ | ------ | ------ |
| `Default value` multipleSelectionApplies | `boolean` | true |
...
*Defined in [blessed/treeView.ts:286](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L286)*
...
*Defined in [blessed/treeView.ts:386](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L386)*
...
*Defined in [blessed/treeView.ts:339](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L339)*
...
| Name | Type | Default value |
| ------ | ------ | ------ |
| `Default value` data | [TreeViewNode](../interfaces/_blessed_treeview_.treeviewnode.md)[] |  this.rootNodes |
...
*Defined in [blessed/treeView.ts:280](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L280)*
...
___
<a id="togglenodehide"></a>

###  toggleNodeHide

▸ **toggleNodeHide**(p: *`function`*): `void`

*Defined in [blessed/treeView.ts:364](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L364)*
...
___
<a id="visitancestors"></a>

###  visitAncestors

▸ **visitAncestors**(n: *[Node](../interfaces/_blessed_treeview_.node.md)*, visitor: *`function`*): `void`

*Defined in [blessed/treeView.ts:427](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L427)*
...
*Defined in [blessed/treeView.ts:353](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L353)*
...
*Defined in [blessed/treeView.ts:134](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L134)*

<a id="defaultoptions.collapsedprefix"></a>

####  collapsedPrefix

**● collapsedPrefix**: *`string`* = "▶"

*Defined in [blessed/treeView.ts:143](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L143)*

___
<a id="defaultoptions.downkeys"></a>

####  downKeys

**● downKeys**: *`string`[]* =  ['down']

*Defined in [blessed/treeView.ts:139](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L139)*

___
<a id="defaultoptions.expandkeys"></a>

####  expandKeys

**● expandKeys**: *`string`[]* =  ['space']

*Defined in [blessed/treeView.ts:136](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L136)*

___
<a id="defaultoptions.expandedprefix"></a>

####  expandedPrefix

**● expandedPrefix**: *`string`* = "▼"

*Defined in [blessed/treeView.ts:142](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L142)*

___
<a id="defaultoptions.levelindent"></a>

####  levelIndent

**● levelIndent**: *`number`* = 2

*Defined in [blessed/treeView.ts:144](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L144)*

___
<a id="defaultoptions.pagedownkeys"></a>

####  pageDownKeys

**● pageDownKeys**: *`string`[]* =  ['pagedown']

*Defined in [blessed/treeView.ts:140](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L140)*

___
<a id="defaultoptions.pageupkeys"></a>

####  pageUpKeys

**● pageUpKeys**: *`string`[]* =  ['pageup']

*Defined in [blessed/treeView.ts:141](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L141)*

___
<a id="defaultoptions.rootnodes-1"></a>

####  rootNodes

**● rootNodes**: *`undefined`[]* =  []

*Defined in [blessed/treeView.ts:135](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L135)*

___
<a id="defaultoptions.selectkeys"></a>

####  selectKeys

**● selectKeys**: *`string`[]* =  ['enter']

*Defined in [blessed/treeView.ts:137](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L137)*

___
<a id="defaultoptions.upkeys"></a>

####  upKeys

**● upKeys**: *`string`[]* =  ['up']

*Defined in [blessed/treeView.ts:138](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L138)*

___
<a id="defaultoptions.style-1"></a>

####  style

**style**: *`object`*

*Defined in [blessed/treeView.ts:145](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L145)*

<a id="defaultoptions.style-1.bg-1"></a>

####  bg

**● bg**: *`string`* = "black"

*Defined in [blessed/treeView.ts:147](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L147)*

___
<a id="defaultoptions.style-1.fg-1"></a>

####  fg

**● fg**: *`string`* = "green"

*Defined in [blessed/treeView.ts:146](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L146)*

___
<a id="defaultoptions.style-1.focusednode"></a>

####  focusedNode

**focusedNode**: *`object`*

*Defined in [blessed/treeView.ts:148](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L148)*

<a id="defaultoptions.style-1.focusednode.bg-2"></a>
...
___
<a id="defaultoptions.style-1.focusednode.fg-2"></a>
...
___
<a id="defaultoptions.style-1.selectednode"></a>

####  selectedNode

**selectedNode**: *`object`*

*Defined in [blessed/treeView.ts:149](https://github.com/cancerberoSgx/accursed/blob/978b980/src/blessed/treeView.ts#L149)*

<a id="defaultoptions.style-1.selectednode.bg-3"></a>
...
___
<a id="defaultoptions.style-1.selectednode.fg-3"></a>
