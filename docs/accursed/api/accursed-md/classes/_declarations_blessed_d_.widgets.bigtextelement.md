[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [Widgets](../modules/_declarations_blessed_d_.widgets.md) › [BigTextElement](_declarations_blessed_d_.widgets.bigtextelement.md)

# Class: BigTextElement <**Options**>
...
## Hierarchy
  ...
  ↳ [BigText](_declarations_blessed_d_.widget.bigtext.md)
...
* [IHasOptions](../interfaces/_declarations_blessed_d_.widgets.ihasoptions.md)‹[BigTextOptions](../interfaces/_declarations_blessed_d_.widgets.bigtextoptions.md)›

## Index

### Constructors

* [constructor](_declarations_blessed_d_.widgets.bigtextelement.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widgets.bigtextelement.md#$)
* [_](_declarations_blessed_d_.widgets.bigtextelement.md#_)
* [_label](_declarations_blessed_d_.widgets.bigtextelement.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widgets.bigtextelement.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widgets.bigtextelement.md#abottom)
* [aleft](_declarations_blessed_d_.widgets.bigtextelement.md#aleft)
* [aright](_declarations_blessed_d_.widgets.bigtextelement.md#aright)
* [atop](_declarations_blessed_d_.widgets.bigtextelement.md#atop)
* [bg](_declarations_blessed_d_.widgets.bigtextelement.md#bg)
* [bold](_declarations_blessed_d_.widgets.bigtextelement.md#bold)
* [border](_declarations_blessed_d_.widgets.bigtextelement.md#border)
* [bottom](_declarations_blessed_d_.widgets.bigtextelement.md#bottom)
* [childBase](_declarations_blessed_d_.widgets.bigtextelement.md#childbase)
* [childOffset](_declarations_blessed_d_.widgets.bigtextelement.md#childoffset)
* [children](_declarations_blessed_d_.widgets.bigtextelement.md#children)
* [content](_declarations_blessed_d_.widgets.bigtextelement.md#content)
* [data](_declarations_blessed_d_.widgets.bigtextelement.md#data)
* [detached](_declarations_blessed_d_.widgets.bigtextelement.md#detached)
* [draggable](_declarations_blessed_d_.widgets.bigtextelement.md#draggable)
* [fg](_declarations_blessed_d_.widgets.bigtextelement.md#fg)
* [focusable](_declarations_blessed_d_.widgets.bigtextelement.md#focusable)
* [height](_declarations_blessed_d_.widgets.bigtextelement.md#height)
* [hidden](_declarations_blessed_d_.widgets.bigtextelement.md#hidden)
* [iheight](_declarations_blessed_d_.widgets.bigtextelement.md#iheight)
* [ileft](_declarations_blessed_d_.widgets.bigtextelement.md#ileft)
* [index](_declarations_blessed_d_.widgets.bigtextelement.md#index)
* [itop](_declarations_blessed_d_.widgets.bigtextelement.md#itop)
* [iwidth](_declarations_blessed_d_.widgets.bigtextelement.md#iwidth)
* [left](_declarations_blessed_d_.widgets.bigtextelement.md#left)
* [lpos](_declarations_blessed_d_.widgets.bigtextelement.md#lpos)
* [name](_declarations_blessed_d_.widgets.bigtextelement.md#name)
* [options](_declarations_blessed_d_.widgets.bigtextelement.md#options)
* [padding](_declarations_blessed_d_.widgets.bigtextelement.md#padding)
* [parent](_declarations_blessed_d_.widgets.bigtextelement.md#optional-parent)
* [position](_declarations_blessed_d_.widgets.bigtextelement.md#position)
* [rbottom](_declarations_blessed_d_.widgets.bigtextelement.md#rbottom)
* [right](_declarations_blessed_d_.widgets.bigtextelement.md#right)
* [rleft](_declarations_blessed_d_.widgets.bigtextelement.md#rleft)
* [rright](_declarations_blessed_d_.widgets.bigtextelement.md#rright)
* [rtop](_declarations_blessed_d_.widgets.bigtextelement.md#rtop)
* [screen](_declarations_blessed_d_.widgets.bigtextelement.md#screen)
* [shrink](_declarations_blessed_d_.widgets.bigtextelement.md#shrink)
* [style](_declarations_blessed_d_.widgets.bigtextelement.md#style)
* [top](_declarations_blessed_d_.widgets.bigtextelement.md#top)
* [tpadding](_declarations_blessed_d_.widgets.bigtextelement.md#tpadding)
* [type](_declarations_blessed_d_.widgets.bigtextelement.md#type)
* [uid](_declarations_blessed_d_.widgets.bigtextelement.md#uid)
* [underline](_declarations_blessed_d_.widgets.bigtextelement.md#underline)
* [visible](_declarations_blessed_d_.widgets.bigtextelement.md#visible)
* [width](_declarations_blessed_d_.widgets.bigtextelement.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widgets.bigtextelement.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widgets.bigtextelement.md#_align)
* [_getBottom](_declarations_blessed_d_.widgets.bigtextelement.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widgets.bigtextelement.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widgets.bigtextelement.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widgets.bigtextelement.md#_getleft)
* [_getPos](_declarations_blessed_d_.widgets.bigtextelement.md#_getpos)
* [_getRight](_declarations_blessed_d_.widgets.bigtextelement.md#_getright)
* [_getShrink](_declarations_blessed_d_.widgets.bigtextelement.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widgets.bigtextelement.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widgets.bigtextelement.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widgets.bigtextelement.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widgets.bigtextelement.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widgets.bigtextelement.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widgets.bigtextelement.md#_wrapcontent)
* [addListener](_declarations_blessed_d_.widgets.bigtextelement.md#addlistener)
* [append](_declarations_blessed_d_.widgets.bigtextelement.md#append)
* [clearBaseLine](_declarations_blessed_d_.widgets.bigtextelement.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widgets.bigtextelement.md#clearline)
* [clearPos](_declarations_blessed_d_.widgets.bigtextelement.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widgets.bigtextelement.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widgets.bigtextelement.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widgets.bigtextelement.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widgets.bigtextelement.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widgets.bigtextelement.md#deletetop)
* [destroy](_declarations_blessed_d_.widgets.bigtextelement.md#destroy)
* [detach](_declarations_blessed_d_.widgets.bigtextelement.md#detach)
* [disableDrag](_declarations_blessed_d_.widgets.bigtextelement.md#disabledrag)
* [emit](_declarations_blessed_d_.widgets.bigtextelement.md#emit)
* [emitAncestors](_declarations_blessed_d_.widgets.bigtextelement.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widgets.bigtextelement.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widgets.bigtextelement.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widgets.bigtextelement.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widgets.bigtextelement.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widgets.bigtextelement.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widgets.bigtextelement.md#eventnames)
* [focus](_declarations_blessed_d_.widgets.bigtextelement.md#focus)
* [forAncestors](_declarations_blessed_d_.widgets.bigtextelement.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widgets.bigtextelement.md#fordescendants)
* [free](_declarations_blessed_d_.widgets.bigtextelement.md#free)
* [get](_declarations_blessed_d_.widgets.bigtextelement.md#get)
* [getBaseLine](_declarations_blessed_d_.widgets.bigtextelement.md#getbaseline)
* [getContent](_declarations_blessed_d_.widgets.bigtextelement.md#getcontent)
* [getLine](_declarations_blessed_d_.widgets.bigtextelement.md#getline)
* [getLines](_declarations_blessed_d_.widgets.bigtextelement.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widgets.bigtextelement.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widgets.bigtextelement.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widgets.bigtextelement.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widgets.bigtextelement.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widgets.bigtextelement.md#getscrollperc)
* [getText](_declarations_blessed_d_.widgets.bigtextelement.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widgets.bigtextelement.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widgets.bigtextelement.md#hasdescendant)
* [hide](_declarations_blessed_d_.widgets.bigtextelement.md#hide)
* [insert](_declarations_blessed_d_.widgets.bigtextelement.md#insert)
* [insertAfter](_declarations_blessed_d_.widgets.bigtextelement.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widgets.bigtextelement.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widgets.bigtextelement.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widgets.bigtextelement.md#insertline)
* [insertTop](_declarations_blessed_d_.widgets.bigtextelement.md#inserttop)
* [key](_declarations_blessed_d_.widgets.bigtextelement.md#key)
* [kill](_declarations_blessed_d_.widgets.bigtextelement.md#kill)
* [listenerCount](_declarations_blessed_d_.widgets.bigtextelement.md#listenercount)
* [listeners](_declarations_blessed_d_.widgets.bigtextelement.md#listeners)
* [off](_declarations_blessed_d_.widgets.bigtextelement.md#off)
* [on](_declarations_blessed_d_.widgets.bigtextelement.md#on)
* [onScreenEvent](_declarations_blessed_d_.widgets.bigtextelement.md#onscreenevent)
* [once](_declarations_blessed_d_.widgets.bigtextelement.md#once)
* [onceKey](_declarations_blessed_d_.widgets.bigtextelement.md#oncekey)
* [parseContent](_declarations_blessed_d_.widgets.bigtextelement.md#parsecontent)
* [popLine](_declarations_blessed_d_.widgets.bigtextelement.md#popline)
* [prepend](_declarations_blessed_d_.widgets.bigtextelement.md#prepend)
* [prependListener](_declarations_blessed_d_.widgets.bigtextelement.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widgets.bigtextelement.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widgets.bigtextelement.md#pushline)
* [rawListeners](_declarations_blessed_d_.widgets.bigtextelement.md#rawlisteners)
* [remove](_declarations_blessed_d_.widgets.bigtextelement.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widgets.bigtextelement.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widgets.bigtextelement.md#removehover)
* [removeKey](_declarations_blessed_d_.widgets.bigtextelement.md#removekey)
* [removeLabel](_declarations_blessed_d_.widgets.bigtextelement.md#removelabel)
* [removeListener](_declarations_blessed_d_.widgets.bigtextelement.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widgets.bigtextelement.md#removescreenevent)
* [render](_declarations_blessed_d_.widgets.bigtextelement.md#render)
* [resetScroll](_declarations_blessed_d_.widgets.bigtextelement.md#resetscroll)
* [sattr](_declarations_blessed_d_.widgets.bigtextelement.md#sattr)
* [screenshot](_declarations_blessed_d_.widgets.bigtextelement.md#screenshot)
* [scroll](_declarations_blessed_d_.widgets.bigtextelement.md#scroll)
* [scrollTo](_declarations_blessed_d_.widgets.bigtextelement.md#scrollto)
* [set](_declarations_blessed_d_.widgets.bigtextelement.md#set)
* [setBack](_declarations_blessed_d_.widgets.bigtextelement.md#setback)
* [setBaseLine](_declarations_blessed_d_.widgets.bigtextelement.md#setbaseline)
* [setContent](_declarations_blessed_d_.widgets.bigtextelement.md#setcontent)
* [setFront](_declarations_blessed_d_.widgets.bigtextelement.md#setfront)
* [setHover](_declarations_blessed_d_.widgets.bigtextelement.md#sethover)
* [setIndex](_declarations_blessed_d_.widgets.bigtextelement.md#setindex)
* [setLabel](_declarations_blessed_d_.widgets.bigtextelement.md#setlabel)
* [setLine](_declarations_blessed_d_.widgets.bigtextelement.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widgets.bigtextelement.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widgets.bigtextelement.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widgets.bigtextelement.md#setscrollperc)
* [setText](_declarations_blessed_d_.widgets.bigtextelement.md#settext)
* [shiftLine](_declarations_blessed_d_.widgets.bigtextelement.md#shiftline)
* [show](_declarations_blessed_d_.widgets.bigtextelement.md#show)
* [strWidth](_declarations_blessed_d_.widgets.bigtextelement.md#strwidth)
* [toggle](_declarations_blessed_d_.widgets.bigtextelement.md#toggle)
* [unkey](_declarations_blessed_d_.widgets.bigtextelement.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widgets.bigtextelement.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widgets.bigtextelement.md#static-listenercount)

## Constructors

###  constructor

\+ **new BigTextElement**(`opts`: [BigTextOptions](../interfaces/_declarations_blessed_d_.widgets.bigtextoptions.md)): *[BigTextElement](_declarations_blessed_d_.widgets.bigtextelement.md)*
...
*Defined in [declarations/blessed.d.ts:2192](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L2192)*

**Parameters:**

Name | Type |
------ | ------ |
`opts` | [BigTextOptions](../interfaces/_declarations_blessed_d_.widgets.bigtextoptions.md) |

**Returns:** *[BigTextElement](_declarations_blessed_d_.widgets.bigtextelement.md)*
...
*Defined in [declarations/blessed.d.ts:2198](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L2198)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widgets.bigtextelement.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widgets.bigtextelement.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widgets.bigtextelement.md#hide) event.
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widgets.bigtextelement.md#setindex)
