[accursed](../README.md) > ["jsx-components/button"](../modules/_jsx_components_button_.md) > [Button2](../classes/_jsx_components_button_.button2.md)
...
* [blessedElement](_jsx_components_button_.button2.md#blessedelement)
* [props](_jsx_components_button_.button2.md#props)
* [state](_jsx_components_button_.button2.md#state)
...
If true then JSX children props will be save on property [\_jsxChildrenProps](_jsx_components_button_.button2.md#_jsxchildrenprops). Component subclasses needing this information (like Virtual component parent) can override it.
