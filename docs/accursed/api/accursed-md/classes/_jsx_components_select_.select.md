[accursed](../README.md) > ["jsx-components/select"](../modules/_jsx_components_select_.md) > [Select](../classes/_jsx_components_select_.select.md)
...
* [blessedElement](_jsx_components_select_.select.md#blessedelement)
* [props](_jsx_components_select_.select.md#props)
* [state](_jsx_components_select_.select.md#state)
...
*Defined in [jsx-components/select.tsx:30](https://github.com/cancerberoSgx/accursed/blob/978b980/src/jsx-components/select.tsx#L30)*
...
*Defined in [jsx-components/select.tsx:31](https://github.com/cancerberoSgx/accursed/blob/978b980/src/jsx-components/select.tsx#L31)*
