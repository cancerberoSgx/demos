[accursed](../README.md) › [Globals](../globals.md) › ["jsx-components/columns"](../modules/_jsx_components_columns_.md) › [Columns](_jsx_components_columns_.columns.md)
...
* [Component](_jsx_component_.component.md)‹[ColumnsProps](../interfaces/_jsx_components_columns_.columnsprops.md)›
...
* [constructor](_jsx_components_columns_.columns.md#constructor)

### Properties

* [_jsxChildrenProps](_jsx_components_columns_.columns.md#_jsxchildrenprops)
* [_saveJSXChildrenProps](_jsx_components_columns_.columns.md#_savejsxchildrenprops)
* [blessedElement](_jsx_components_columns_.columns.md#protected-blessedelement)
* [props](_jsx_components_columns_.columns.md#protected-props)
* [state](_jsx_components_columns_.columns.md#protected-state)

### Accessors

* [element](_jsx_components_columns_.columns.md#element)
* [screen](_jsx_components_columns_.columns.md#screen)
* [type](_jsx_components_columns_.columns.md#type)

### Methods

* [filterChildren](_jsx_components_columns_.columns.md#filterchildren)
* [filterDescendants](_jsx_components_columns_.columns.md#filterdescendants)
* [findChildren](_jsx_components_columns_.columns.md#findchildren)
* [findDescendant](_jsx_components_columns_.columns.md#finddescendant)
* [findDescendantNamed](_jsx_components_columns_.columns.md#finddescendantnamed)
* [getContent](_jsx_components_columns_.columns.md#getcontent)
* [getDescendantNamed](_jsx_components_columns_.columns.md#getdescendantnamed)
* [getElementData](_jsx_components_columns_.columns.md#getelementdata)
* [render](_jsx_components_columns_.columns.md#render)
* [replaceChildren](_jsx_components_columns_.columns.md#replacechildren)
* [visitDescendants](_jsx_components_columns_.columns.md#visitdescendants)

## Constructors

###  constructor

\+ **new Columns**(`props`: P, `state`: S): *[Columns](_jsx_components_columns_.columns.md)*
...
**Returns:** *[Columns](_jsx_components_columns_.columns.md)*
...
*Defined in [jsx-components/columns.tsx:39](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/jsx-components/columns.tsx#L39)*
...
*Defined in [jsx-components/columns.tsx:40](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/jsx-components/columns.tsx#L40)*
