[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [widget](../modules/_declarations_blessed_d_.widget.md) › [Text](_declarations_blessed_d_.widget.text.md)
...
## Hierarchy
  ...
  ↳ [TextElement](_declarations_blessed_d_.widgets.textelement.md)‹Options›
...
* [constructor](_declarations_blessed_d_.widget.text.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widget.text.md#$)
* [_](_declarations_blessed_d_.widget.text.md#_)
* [_label](_declarations_blessed_d_.widget.text.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widget.text.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widget.text.md#abottom)
* [aleft](_declarations_blessed_d_.widget.text.md#aleft)
* [aright](_declarations_blessed_d_.widget.text.md#aright)
* [atop](_declarations_blessed_d_.widget.text.md#atop)
* [bg](_declarations_blessed_d_.widget.text.md#bg)
* [bold](_declarations_blessed_d_.widget.text.md#bold)
* [border](_declarations_blessed_d_.widget.text.md#border)
* [bottom](_declarations_blessed_d_.widget.text.md#bottom)
* [children](_declarations_blessed_d_.widget.text.md#children)
* [content](_declarations_blessed_d_.widget.text.md#content)
* [data](_declarations_blessed_d_.widget.text.md#data)
* [detached](_declarations_blessed_d_.widget.text.md#detached)
* [draggable](_declarations_blessed_d_.widget.text.md#draggable)
* [fg](_declarations_blessed_d_.widget.text.md#fg)
* [focusable](_declarations_blessed_d_.widget.text.md#focusable)
* [height](_declarations_blessed_d_.widget.text.md#height)
* [hidden](_declarations_blessed_d_.widget.text.md#hidden)
* [iheight](_declarations_blessed_d_.widget.text.md#iheight)
* [ileft](_declarations_blessed_d_.widget.text.md#ileft)
* [index](_declarations_blessed_d_.widget.text.md#index)
* [itop](_declarations_blessed_d_.widget.text.md#itop)
* [iwidth](_declarations_blessed_d_.widget.text.md#iwidth)
* [left](_declarations_blessed_d_.widget.text.md#left)
* [lpos](_declarations_blessed_d_.widget.text.md#lpos)
* [name](_declarations_blessed_d_.widget.text.md#name)
* [options](_declarations_blessed_d_.widget.text.md#options)
* [padding](_declarations_blessed_d_.widget.text.md#padding)
* [parent](_declarations_blessed_d_.widget.text.md#optional-parent)
* [position](_declarations_blessed_d_.widget.text.md#position)
* [rbottom](_declarations_blessed_d_.widget.text.md#rbottom)
* [right](_declarations_blessed_d_.widget.text.md#right)
* [rleft](_declarations_blessed_d_.widget.text.md#rleft)
* [rright](_declarations_blessed_d_.widget.text.md#rright)
* [rtop](_declarations_blessed_d_.widget.text.md#rtop)
* [screen](_declarations_blessed_d_.widget.text.md#screen)
* [shrink](_declarations_blessed_d_.widget.text.md#shrink)
* [style](_declarations_blessed_d_.widget.text.md#style)
* [top](_declarations_blessed_d_.widget.text.md#top)
* [tpadding](_declarations_blessed_d_.widget.text.md#tpadding)
* [type](_declarations_blessed_d_.widget.text.md#type)
* [uid](_declarations_blessed_d_.widget.text.md#uid)
* [underline](_declarations_blessed_d_.widget.text.md#underline)
* [visible](_declarations_blessed_d_.widget.text.md#visible)
* [width](_declarations_blessed_d_.widget.text.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widget.text.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widget.text.md#_align)
* [_getBottom](_declarations_blessed_d_.widget.text.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widget.text.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widget.text.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widget.text.md#_getleft)
* [_getPos](_declarations_blessed_d_.widget.text.md#_getpos)
* [_getRight](_declarations_blessed_d_.widget.text.md#_getright)
* [_getShrink](_declarations_blessed_d_.widget.text.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widget.text.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widget.text.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widget.text.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widget.text.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widget.text.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widget.text.md#_wrapcontent)
* [addListener](_declarations_blessed_d_.widget.text.md#addlistener)
* [append](_declarations_blessed_d_.widget.text.md#append)
* [clearBaseLine](_declarations_blessed_d_.widget.text.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widget.text.md#clearline)
* [clearPos](_declarations_blessed_d_.widget.text.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widget.text.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widget.text.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widget.text.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widget.text.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widget.text.md#deletetop)
* [destroy](_declarations_blessed_d_.widget.text.md#destroy)
* [detach](_declarations_blessed_d_.widget.text.md#detach)
* [disableDrag](_declarations_blessed_d_.widget.text.md#disabledrag)
* [emit](_declarations_blessed_d_.widget.text.md#emit)
* [emitAncestors](_declarations_blessed_d_.widget.text.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widget.text.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widget.text.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widget.text.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widget.text.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widget.text.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widget.text.md#eventnames)
* [focus](_declarations_blessed_d_.widget.text.md#focus)
* [forAncestors](_declarations_blessed_d_.widget.text.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widget.text.md#fordescendants)
* [free](_declarations_blessed_d_.widget.text.md#free)
* [get](_declarations_blessed_d_.widget.text.md#get)
* [getBaseLine](_declarations_blessed_d_.widget.text.md#getbaseline)
* [getContent](_declarations_blessed_d_.widget.text.md#getcontent)
* [getLine](_declarations_blessed_d_.widget.text.md#getline)
* [getLines](_declarations_blessed_d_.widget.text.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widget.text.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widget.text.md#getscreenlines)
* [getText](_declarations_blessed_d_.widget.text.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widget.text.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widget.text.md#hasdescendant)
* [hide](_declarations_blessed_d_.widget.text.md#hide)
* [insert](_declarations_blessed_d_.widget.text.md#insert)
* [insertAfter](_declarations_blessed_d_.widget.text.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widget.text.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widget.text.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widget.text.md#insertline)
* [insertTop](_declarations_blessed_d_.widget.text.md#inserttop)
* [key](_declarations_blessed_d_.widget.text.md#key)
* [kill](_declarations_blessed_d_.widget.text.md#kill)
* [listenerCount](_declarations_blessed_d_.widget.text.md#listenercount)
* [listeners](_declarations_blessed_d_.widget.text.md#listeners)
* [off](_declarations_blessed_d_.widget.text.md#off)
* [on](_declarations_blessed_d_.widget.text.md#on)
* [onScreenEvent](_declarations_blessed_d_.widget.text.md#onscreenevent)
* [once](_declarations_blessed_d_.widget.text.md#once)
* [onceKey](_declarations_blessed_d_.widget.text.md#oncekey)
* [parseContent](_declarations_blessed_d_.widget.text.md#parsecontent)
* [popLine](_declarations_blessed_d_.widget.text.md#popline)
* [prepend](_declarations_blessed_d_.widget.text.md#prepend)
* [prependListener](_declarations_blessed_d_.widget.text.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widget.text.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widget.text.md#pushline)
* [rawListeners](_declarations_blessed_d_.widget.text.md#rawlisteners)
* [remove](_declarations_blessed_d_.widget.text.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widget.text.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widget.text.md#removehover)
* [removeKey](_declarations_blessed_d_.widget.text.md#removekey)
* [removeLabel](_declarations_blessed_d_.widget.text.md#removelabel)
* [removeListener](_declarations_blessed_d_.widget.text.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widget.text.md#removescreenevent)
* [render](_declarations_blessed_d_.widget.text.md#render)
* [sattr](_declarations_blessed_d_.widget.text.md#sattr)
* [screenshot](_declarations_blessed_d_.widget.text.md#screenshot)
* [set](_declarations_blessed_d_.widget.text.md#set)
* [setBack](_declarations_blessed_d_.widget.text.md#setback)
* [setBaseLine](_declarations_blessed_d_.widget.text.md#setbaseline)
* [setContent](_declarations_blessed_d_.widget.text.md#setcontent)
* [setFront](_declarations_blessed_d_.widget.text.md#setfront)
* [setHover](_declarations_blessed_d_.widget.text.md#sethover)
* [setIndex](_declarations_blessed_d_.widget.text.md#setindex)
* [setLabel](_declarations_blessed_d_.widget.text.md#setlabel)
* [setLine](_declarations_blessed_d_.widget.text.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widget.text.md#setmaxlisteners)
* [setText](_declarations_blessed_d_.widget.text.md#settext)
* [shiftLine](_declarations_blessed_d_.widget.text.md#shiftline)
* [show](_declarations_blessed_d_.widget.text.md#show)
* [strWidth](_declarations_blessed_d_.widget.text.md#strwidth)
* [toggle](_declarations_blessed_d_.widget.text.md#toggle)
* [unkey](_declarations_blessed_d_.widget.text.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widget.text.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widget.text.md#static-listenercount)

## Constructors

###  constructor

\+ **new Text**(`opts`: [TextOptions](../interfaces/_declarations_blessed_d_.widgets.textoptions.md)): *[Text](_declarations_blessed_d_.widget.text.md)*

*Inherited from [TextElement](_declarations_blessed_d_.widgets.textelement.md).[constructor](_declarations_blessed_d_.widgets.textelement.md#constructor)*
...
**Returns:** *[Text](_declarations_blessed_d_.widget.text.md)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widget.text.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widget.text.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widget.text.md#hide) event.
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widget.text.md#setindex)
