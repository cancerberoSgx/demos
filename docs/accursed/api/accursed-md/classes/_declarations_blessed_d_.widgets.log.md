[accursed](../README.md) > ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) > [Widgets](../modules/_declarations_blessed_d_.widgets.md) > [Log](../classes/_declarations_blessed_d_.widgets.log.md)
...
* [$](_declarations_blessed_d_.widgets.log.md#_)
* [_](_declarations_blessed_d_.widgets.log.md#_-1)
* [_label](_declarations_blessed_d_.widgets.log.md#_label)
* [_noFill](_declarations_blessed_d_.widgets.log.md#_nofill)
...
* [parent](_declarations_blessed_d_.widgets.log.md#parent)
...
* [defaultMaxListeners](_declarations_blessed_d_.widgets.log.md#defaultmaxlisteners)
...
* [listenerCount](_declarations_blessed_d_.widgets.log.md#listenercount-1)
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `Optional` get | `boolean` |  it's passed to [\_getCoords](_declarations_blessed_d_.widgets.log.md#_getcoords) |
