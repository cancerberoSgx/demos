[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [Widgets](../modules/_declarations_blessed_d_.widgets.md) › [Log](_declarations_blessed_d_.widgets.log.md)
...
## Hierarchy
  ...
  ↳ [Log](_declarations_blessed_d_.widget.log.md)
...
* [constructor](_declarations_blessed_d_.widgets.log.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widgets.log.md#$)
* [_](_declarations_blessed_d_.widgets.log.md#_)
* [_label](_declarations_blessed_d_.widgets.log.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widgets.log.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widgets.log.md#abottom)
* [aleft](_declarations_blessed_d_.widgets.log.md#aleft)
* [aright](_declarations_blessed_d_.widgets.log.md#aright)
* [atop](_declarations_blessed_d_.widgets.log.md#atop)
* [bg](_declarations_blessed_d_.widgets.log.md#bg)
* [bold](_declarations_blessed_d_.widgets.log.md#bold)
* [border](_declarations_blessed_d_.widgets.log.md#border)
* [bottom](_declarations_blessed_d_.widgets.log.md#bottom)
* [childBase](_declarations_blessed_d_.widgets.log.md#childbase)
* [childOffset](_declarations_blessed_d_.widgets.log.md#childoffset)
* [children](_declarations_blessed_d_.widgets.log.md#children)
* [content](_declarations_blessed_d_.widgets.log.md#content)
* [data](_declarations_blessed_d_.widgets.log.md#data)
* [detached](_declarations_blessed_d_.widgets.log.md#detached)
* [draggable](_declarations_blessed_d_.widgets.log.md#draggable)
* [fg](_declarations_blessed_d_.widgets.log.md#fg)
* [focusable](_declarations_blessed_d_.widgets.log.md#focusable)
* [height](_declarations_blessed_d_.widgets.log.md#height)
* [hidden](_declarations_blessed_d_.widgets.log.md#hidden)
* [iheight](_declarations_blessed_d_.widgets.log.md#iheight)
* [ileft](_declarations_blessed_d_.widgets.log.md#ileft)
* [index](_declarations_blessed_d_.widgets.log.md#index)
* [itop](_declarations_blessed_d_.widgets.log.md#itop)
* [iwidth](_declarations_blessed_d_.widgets.log.md#iwidth)
* [left](_declarations_blessed_d_.widgets.log.md#left)
* [lpos](_declarations_blessed_d_.widgets.log.md#lpos)
* [name](_declarations_blessed_d_.widgets.log.md#name)
* [options](_declarations_blessed_d_.widgets.log.md#options)
* [padding](_declarations_blessed_d_.widgets.log.md#padding)
* [parent](_declarations_blessed_d_.widgets.log.md#optional-parent)
* [position](_declarations_blessed_d_.widgets.log.md#position)
* [rbottom](_declarations_blessed_d_.widgets.log.md#rbottom)
* [right](_declarations_blessed_d_.widgets.log.md#right)
* [rleft](_declarations_blessed_d_.widgets.log.md#rleft)
* [rright](_declarations_blessed_d_.widgets.log.md#rright)
* [rtop](_declarations_blessed_d_.widgets.log.md#rtop)
* [screen](_declarations_blessed_d_.widgets.log.md#screen)
* [scrollOnInput](_declarations_blessed_d_.widgets.log.md#scrolloninput)
* [scrollback](_declarations_blessed_d_.widgets.log.md#scrollback)
* [shrink](_declarations_blessed_d_.widgets.log.md#shrink)
* [style](_declarations_blessed_d_.widgets.log.md#style)
* [top](_declarations_blessed_d_.widgets.log.md#top)
* [tpadding](_declarations_blessed_d_.widgets.log.md#tpadding)
* [type](_declarations_blessed_d_.widgets.log.md#type)
* [uid](_declarations_blessed_d_.widgets.log.md#uid)
* [underline](_declarations_blessed_d_.widgets.log.md#underline)
* [visible](_declarations_blessed_d_.widgets.log.md#visible)
* [width](_declarations_blessed_d_.widgets.log.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widgets.log.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widgets.log.md#_align)
* [_getBottom](_declarations_blessed_d_.widgets.log.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widgets.log.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widgets.log.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widgets.log.md#_getleft)
* [_getPos](_declarations_blessed_d_.widgets.log.md#_getpos)
* [_getRight](_declarations_blessed_d_.widgets.log.md#_getright)
* [_getShrink](_declarations_blessed_d_.widgets.log.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widgets.log.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widgets.log.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widgets.log.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widgets.log.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widgets.log.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widgets.log.md#_wrapcontent)
* [add](_declarations_blessed_d_.widgets.log.md#add)
* [addListener](_declarations_blessed_d_.widgets.log.md#addlistener)
* [append](_declarations_blessed_d_.widgets.log.md#append)
* [clearBaseLine](_declarations_blessed_d_.widgets.log.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widgets.log.md#clearline)
* [clearPos](_declarations_blessed_d_.widgets.log.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widgets.log.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widgets.log.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widgets.log.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widgets.log.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widgets.log.md#deletetop)
* [destroy](_declarations_blessed_d_.widgets.log.md#destroy)
* [detach](_declarations_blessed_d_.widgets.log.md#detach)
* [disableDrag](_declarations_blessed_d_.widgets.log.md#disabledrag)
* [emit](_declarations_blessed_d_.widgets.log.md#emit)
* [emitAncestors](_declarations_blessed_d_.widgets.log.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widgets.log.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widgets.log.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widgets.log.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widgets.log.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widgets.log.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widgets.log.md#eventnames)
* [focus](_declarations_blessed_d_.widgets.log.md#focus)
* [forAncestors](_declarations_blessed_d_.widgets.log.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widgets.log.md#fordescendants)
* [free](_declarations_blessed_d_.widgets.log.md#free)
* [get](_declarations_blessed_d_.widgets.log.md#get)
* [getBaseLine](_declarations_blessed_d_.widgets.log.md#getbaseline)
* [getContent](_declarations_blessed_d_.widgets.log.md#getcontent)
* [getLine](_declarations_blessed_d_.widgets.log.md#getline)
* [getLines](_declarations_blessed_d_.widgets.log.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widgets.log.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widgets.log.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widgets.log.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widgets.log.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widgets.log.md#getscrollperc)
* [getText](_declarations_blessed_d_.widgets.log.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widgets.log.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widgets.log.md#hasdescendant)
* [hide](_declarations_blessed_d_.widgets.log.md#hide)
* [insert](_declarations_blessed_d_.widgets.log.md#insert)
* [insertAfter](_declarations_blessed_d_.widgets.log.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widgets.log.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widgets.log.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widgets.log.md#insertline)
* [insertTop](_declarations_blessed_d_.widgets.log.md#inserttop)
* [key](_declarations_blessed_d_.widgets.log.md#key)
* [kill](_declarations_blessed_d_.widgets.log.md#kill)
* [listenerCount](_declarations_blessed_d_.widgets.log.md#listenercount)
* [listeners](_declarations_blessed_d_.widgets.log.md#listeners)
* [log](_declarations_blessed_d_.widgets.log.md#log)
* [off](_declarations_blessed_d_.widgets.log.md#off)
* [on](_declarations_blessed_d_.widgets.log.md#on)
* [onScreenEvent](_declarations_blessed_d_.widgets.log.md#onscreenevent)
* [once](_declarations_blessed_d_.widgets.log.md#once)
* [onceKey](_declarations_blessed_d_.widgets.log.md#oncekey)
* [parseContent](_declarations_blessed_d_.widgets.log.md#parsecontent)
* [popLine](_declarations_blessed_d_.widgets.log.md#popline)
* [prepend](_declarations_blessed_d_.widgets.log.md#prepend)
* [prependListener](_declarations_blessed_d_.widgets.log.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widgets.log.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widgets.log.md#pushline)
* [rawListeners](_declarations_blessed_d_.widgets.log.md#rawlisteners)
* [remove](_declarations_blessed_d_.widgets.log.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widgets.log.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widgets.log.md#removehover)
* [removeKey](_declarations_blessed_d_.widgets.log.md#removekey)
* [removeLabel](_declarations_blessed_d_.widgets.log.md#removelabel)
* [removeListener](_declarations_blessed_d_.widgets.log.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widgets.log.md#removescreenevent)
* [render](_declarations_blessed_d_.widgets.log.md#render)
* [resetScroll](_declarations_blessed_d_.widgets.log.md#resetscroll)
* [sattr](_declarations_blessed_d_.widgets.log.md#sattr)
* [screenshot](_declarations_blessed_d_.widgets.log.md#screenshot)
* [scroll](_declarations_blessed_d_.widgets.log.md#scroll)
* [scrollTo](_declarations_blessed_d_.widgets.log.md#scrollto)
* [set](_declarations_blessed_d_.widgets.log.md#set)
* [setBack](_declarations_blessed_d_.widgets.log.md#setback)
* [setBaseLine](_declarations_blessed_d_.widgets.log.md#setbaseline)
* [setContent](_declarations_blessed_d_.widgets.log.md#setcontent)
* [setFront](_declarations_blessed_d_.widgets.log.md#setfront)
* [setHover](_declarations_blessed_d_.widgets.log.md#sethover)
* [setIndex](_declarations_blessed_d_.widgets.log.md#setindex)
* [setLabel](_declarations_blessed_d_.widgets.log.md#setlabel)
* [setLine](_declarations_blessed_d_.widgets.log.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widgets.log.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widgets.log.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widgets.log.md#setscrollperc)
* [setText](_declarations_blessed_d_.widgets.log.md#settext)
* [shiftLine](_declarations_blessed_d_.widgets.log.md#shiftline)
* [show](_declarations_blessed_d_.widgets.log.md#show)
* [strWidth](_declarations_blessed_d_.widgets.log.md#strwidth)
* [toggle](_declarations_blessed_d_.widgets.log.md#toggle)
* [unkey](_declarations_blessed_d_.widgets.log.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widgets.log.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widgets.log.md#static-listenercount)

## Constructors

###  constructor

\+ **new Log**(`options?`: [LogOptions](../interfaces/_declarations_blessed_d_.widgets.logoptions.md)): *[Log](_declarations_blessed_d_.widgets.log.md)*
...
**Returns:** *[Log](_declarations_blessed_d_.widgets.log.md)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widgets.log.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widgets.log.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widgets.log.md#hide) event.
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widgets.log.md#setindex)
