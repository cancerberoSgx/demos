[accursed](../README.md) › [Globals](../globals.md) › ["jsx-components/rows"](../modules/_jsx_components_rows_.md) › [Rows](_jsx_components_rows_.rows.md)
...
* [Component](_jsx_component_.component.md)‹[RowsProps](../interfaces/_jsx_components_rows_.rowsprops.md)›
...
* [constructor](_jsx_components_rows_.rows.md#constructor)

### Properties

* [_jsxChildrenProps](_jsx_components_rows_.rows.md#_jsxchildrenprops)
* [_saveJSXChildrenProps](_jsx_components_rows_.rows.md#_savejsxchildrenprops)
* [blessedElement](_jsx_components_rows_.rows.md#protected-blessedelement)
* [props](_jsx_components_rows_.rows.md#protected-props)
* [state](_jsx_components_rows_.rows.md#protected-state)

### Accessors

* [element](_jsx_components_rows_.rows.md#element)
* [screen](_jsx_components_rows_.rows.md#screen)
* [type](_jsx_components_rows_.rows.md#type)

### Methods

* [filterChildren](_jsx_components_rows_.rows.md#filterchildren)
* [filterDescendants](_jsx_components_rows_.rows.md#filterdescendants)
* [findChildren](_jsx_components_rows_.rows.md#findchildren)
* [findDescendant](_jsx_components_rows_.rows.md#finddescendant)
* [findDescendantNamed](_jsx_components_rows_.rows.md#finddescendantnamed)
* [getContent](_jsx_components_rows_.rows.md#getcontent)
* [getDescendantNamed](_jsx_components_rows_.rows.md#getdescendantnamed)
* [getElementData](_jsx_components_rows_.rows.md#getelementdata)
* [render](_jsx_components_rows_.rows.md#render)
* [replaceChildren](_jsx_components_rows_.rows.md#replacechildren)
* [visitDescendants](_jsx_components_rows_.rows.md#visitdescendants)

## Constructors

###  constructor

\+ **new Rows**(`props`: P, `state`: S): *[Rows](_jsx_components_rows_.rows.md)*
...
**Returns:** *[Rows](_jsx_components_rows_.rows.md)*
...
*Defined in [jsx-components/rows.tsx:39](https://github.com/cancerberoSgx/accursed/blob/5b2518e/src/jsx-components/rows.tsx#L39)*
...
*Defined in [jsx-components/rows.tsx:40](https://github.com/cancerberoSgx/accursed/blob/5b2518e/src/jsx-components/rows.tsx#L40)*
