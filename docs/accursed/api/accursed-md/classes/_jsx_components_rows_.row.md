[accursed](../README.md) › [Globals](../globals.md) › ["jsx-components/rows"](../modules/_jsx_components_rows_.md) › [Row](_jsx_components_rows_.row.md)
...
## Hierarchy
  ...
  ↳ [VirtualComponent](_blessed_virtualelement_.virtualcomponent.md)‹[RowProps](../interfaces/_jsx_components_rows_.rowprops.md)›
...
* [constructor](_jsx_components_rows_.row.md#constructor)

### Properties

* [_jsxChildrenProps](_jsx_components_rows_.row.md#_jsxchildrenprops)
* [_saveJSXChildrenProps](_jsx_components_rows_.row.md#_savejsxchildrenprops)
* [blessedElement](_jsx_components_rows_.row.md#protected-blessedelement)
* [props](_jsx_components_rows_.row.md#protected-props)
* [state](_jsx_components_rows_.row.md#protected-state)
* [VIRTUAL_DATA_OPTION](_jsx_components_rows_.row.md#static-virtual_data_option)

### Accessors

* [element](_jsx_components_rows_.row.md#element)
* [screen](_jsx_components_rows_.row.md#screen)
* [type](_jsx_components_rows_.row.md#type)

### Methods

* [filterChildren](_jsx_components_rows_.row.md#filterchildren)
* [filterDescendants](_jsx_components_rows_.row.md#filterdescendants)
* [findChildren](_jsx_components_rows_.row.md#findchildren)
* [findDescendant](_jsx_components_rows_.row.md#finddescendant)
* [findDescendantNamed](_jsx_components_rows_.row.md#finddescendantnamed)
* [getContent](_jsx_components_rows_.row.md#getcontent)
* [getDescendantNamed](_jsx_components_rows_.row.md#getdescendantnamed)
* [getElementData](_jsx_components_rows_.row.md#getelementdata)
* [render](_jsx_components_rows_.row.md#render)
* [replaceChildren](_jsx_components_rows_.row.md#replacechildren)
* [saveVirtualData](_jsx_components_rows_.row.md#savevirtualdata)
* [visitDescendants](_jsx_components_rows_.row.md#visitdescendants)
* [createVirtualComponent](_jsx_components_rows_.row.md#static-createvirtualcomponent)
* [createVirtualElement](_jsx_components_rows_.row.md#static-createvirtualelement)
* [isVirtualComponent](_jsx_components_rows_.row.md#static-isvirtualcomponent)
* [isVirtualElement](_jsx_components_rows_.row.md#static-isvirtualelement)

## Constructors

###  constructor

\+ **new Row**(`props`: P, `state`: S): *[Row](_jsx_components_rows_.row.md)*
...
**Returns:** *[Row](_jsx_components_rows_.row.md)*
...
If true then JSX children props will be save on property [_jsxChildrenProps](_jsx_components_rows_.row.md#_jsxchildrenprops). Component subclasses
