[accursed](../README.md) > ["jsx-components/rows"](../modules/_jsx_components_rows_.md) > [Row](../classes/_jsx_components_rows_.row.md)
...
* [blessedElement](_jsx_components_rows_.row.md#blessedelement)
* [props](_jsx_components_rows_.row.md#props)
* [state](_jsx_components_rows_.row.md#state)
* [VIRTUAL_DATA_OPTION](_jsx_components_rows_.row.md#virtual_data_option)
...
* [createVirtualComponent](_jsx_components_rows_.row.md#createvirtualcomponent)
* [createVirtualElement](_jsx_components_rows_.row.md#createvirtualelement)
* [isVirtualComponent](_jsx_components_rows_.row.md#isvirtualcomponent)
* [isVirtualElement](_jsx_components_rows_.row.md#isvirtualelement)
...
If true then JSX children props will be save on property [\_jsxChildrenProps](_jsx_components_rows_.row.md#_jsxchildrenprops). Component subclasses needing this information (like Virtual component parent) can override it.
