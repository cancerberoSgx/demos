[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [Widgets](../modules/_declarations_blessed_d_.widgets.md) › [ListbarElement](_declarations_blessed_d_.widgets.listbarelement.md)

# Class: ListbarElement <**Options**>
...
action to call method [select](_declarations_blessed_d_.widgets.listbarelement.md#select), [move](_declarations_blessed_d_.widgets.listbarelement.md#move), etc.
...
Finally calling method [selectTab](_declarations_blessed_d_.widgets.listbarelement.md#selecttab) wil emit event `select tab` which happens when user pressed one of the [autoCommandKeys](../interfaces/_declarations_blessed_d_.widgets.listbaroptions.md#optional-autocommandkeys)
...
* [$](_declarations_blessed_d_.widgets.listbarelement.md#$)
* [_](_declarations_blessed_d_.widgets.listbarelement.md#_)
* [_label](_declarations_blessed_d_.widgets.listbarelement.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widgets.listbarelement.md#optional-_nofill)
...
* [parent](_declarations_blessed_d_.widgets.listbarelement.md#optional-parent)
...
* [defaultMaxListeners](_declarations_blessed_d_.widgets.listbarelement.md#static-defaultmaxlisteners)
...
* [listenerCount](_declarations_blessed_d_.widgets.listbarelement.md#static-listenercount)
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widgets.listbarelement.md#_getcoords) |
...
[setItems](_declarations_blessed_d_.widgets.listbarelement.md#setitems) is called.
...
callbacks are not called in this method. The same for other methods based on this one like [move](_declarations_blessed_d_.widgets.listbarelement.md#move),
[moveLeft](_declarations_blessed_d_.widgets.listbarelement.md#moveleft), etc.
