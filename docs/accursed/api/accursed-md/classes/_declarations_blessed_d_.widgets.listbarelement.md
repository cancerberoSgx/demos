[accursed](../README.md) > ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) > [Widgets](../modules/_declarations_blessed_d_.widgets.md) > [ListbarElement](../classes/_declarations_blessed_d_.widgets.listbarelement.md)

# Class: ListbarElement

Implements an horizontal list of actionable items with an easy to use command definition API, keybinding and focus.

Key binding: The [keys](../interfaces/_jsx_types_.__global.jsx.reactnodearray.md#keys) property provided in commands, if any, are automatically and globally bind and will activate the command.
...
When the user uses the arrow keys to focus/scroll through the list items the event `select item` is emitted. Notice that the user didn't actionate the command yet, is just exploring. This is the equivalent action to call method [select](_declarations_blessed_d_.widgets.listbarelement.md#select), [move](_declarations_blessed_d_.widgets.listbarelement.md#move), etc.

On the other hand, when the user clicks an item, or presses enter / space when standing on the item, the event `select` or `action` which is an alias are emitted.

Finally calling method [selectTab](_declarations_blessed_d_.widgets.listbarelement.md#selecttab) wil emit event `select tab` which happens when user pressed one of the [autoCommandKeys](../interfaces/_declarations_blessed_d_.widgets.listbaroptions.md#autocommandkeys)

Although it doesnt' implements [ListElement](_declarations_blessed_d_.widgets.listelement.md) it has similar interface. and an elegant cmmand selection.
...
↳  [Listbar](_declarations_blessed_d_.widget.listbar.md)
...
* [IHasOptions](../interfaces/_declarations_blessed_d_.widgets.ihasoptions.md)<[ListbarOptions](../interfaces/_declarations_blessed_d_.widgets.listbaroptions.md)>

## Index

### Constructors

* [constructor](_declarations_blessed_d_.widgets.listbarelement.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widgets.listbarelement.md#_)
* [_](_declarations_blessed_d_.widgets.listbarelement.md#_-1)
* [_label](_declarations_blessed_d_.widgets.listbarelement.md#_label)
* [_noFill](_declarations_blessed_d_.widgets.listbarelement.md#_nofill)
* [abottom](_declarations_blessed_d_.widgets.listbarelement.md#abottom)
* [aleft](_declarations_blessed_d_.widgets.listbarelement.md#aleft)
* [aright](_declarations_blessed_d_.widgets.listbarelement.md#aright)
* [atop](_declarations_blessed_d_.widgets.listbarelement.md#atop)
* [bg](_declarations_blessed_d_.widgets.listbarelement.md#bg)
* [bold](_declarations_blessed_d_.widgets.listbarelement.md#bold)
* [border](_declarations_blessed_d_.widgets.listbarelement.md#border)
* [bottom](_declarations_blessed_d_.widgets.listbarelement.md#bottom)
* [childBase](_declarations_blessed_d_.widgets.listbarelement.md#childbase)
* [childOffset](_declarations_blessed_d_.widgets.listbarelement.md#childoffset)
* [children](_declarations_blessed_d_.widgets.listbarelement.md#children)
* [commands](_declarations_blessed_d_.widgets.listbarelement.md#commands)
* [content](_declarations_blessed_d_.widgets.listbarelement.md#content)
* [data](_declarations_blessed_d_.widgets.listbarelement.md#data)
* [detached](_declarations_blessed_d_.widgets.listbarelement.md#detached)
* [draggable](_declarations_blessed_d_.widgets.listbarelement.md#draggable)
* [fg](_declarations_blessed_d_.widgets.listbarelement.md#fg)
* [focusable](_declarations_blessed_d_.widgets.listbarelement.md#focusable)
* [height](_declarations_blessed_d_.widgets.listbarelement.md#height)
* [hidden](_declarations_blessed_d_.widgets.listbarelement.md#hidden)
* [iheight](_declarations_blessed_d_.widgets.listbarelement.md#iheight)
* [ileft](_declarations_blessed_d_.widgets.listbarelement.md#ileft)
* [index](_declarations_blessed_d_.widgets.listbarelement.md#index)
* [items](_declarations_blessed_d_.widgets.listbarelement.md#items)
* [itop](_declarations_blessed_d_.widgets.listbarelement.md#itop)
* [iwidth](_declarations_blessed_d_.widgets.listbarelement.md#iwidth)
* [left](_declarations_blessed_d_.widgets.listbarelement.md#left)
* [lpos](_declarations_blessed_d_.widgets.listbarelement.md#lpos)
* [name](_declarations_blessed_d_.widgets.listbarelement.md#name)
* [options](_declarations_blessed_d_.widgets.listbarelement.md#options)
* [padding](_declarations_blessed_d_.widgets.listbarelement.md#padding)
* [parent](_declarations_blessed_d_.widgets.listbarelement.md#parent)
* [position](_declarations_blessed_d_.widgets.listbarelement.md#position)
* [rbottom](_declarations_blessed_d_.widgets.listbarelement.md#rbottom)
* [right](_declarations_blessed_d_.widgets.listbarelement.md#right)
* [ritems](_declarations_blessed_d_.widgets.listbarelement.md#ritems)
* [rleft](_declarations_blessed_d_.widgets.listbarelement.md#rleft)
* [rright](_declarations_blessed_d_.widgets.listbarelement.md#rright)
* [rtop](_declarations_blessed_d_.widgets.listbarelement.md#rtop)
* [screen](_declarations_blessed_d_.widgets.listbarelement.md#screen)
* [selected](_declarations_blessed_d_.widgets.listbarelement.md#selected)
* [shrink](_declarations_blessed_d_.widgets.listbarelement.md#shrink)
* [style](_declarations_blessed_d_.widgets.listbarelement.md#style)
* [top](_declarations_blessed_d_.widgets.listbarelement.md#top)
* [tpadding](_declarations_blessed_d_.widgets.listbarelement.md#tpadding)
* [type](_declarations_blessed_d_.widgets.listbarelement.md#type)
* [uid](_declarations_blessed_d_.widgets.listbarelement.md#uid)
* [underline](_declarations_blessed_d_.widgets.listbarelement.md#underline)
* [visible](_declarations_blessed_d_.widgets.listbarelement.md#visible)
* [width](_declarations_blessed_d_.widgets.listbarelement.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widgets.listbarelement.md#defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widgets.listbarelement.md#_align)
* [_getBottom](_declarations_blessed_d_.widgets.listbarelement.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widgets.listbarelement.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widgets.listbarelement.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widgets.listbarelement.md#_getleft)
* [_getPos](_declarations_blessed_d_.widgets.listbarelement.md#_getpos)
* [_getRight](_declarations_blessed_d_.widgets.listbarelement.md#_getright)
* [_getShrink](_declarations_blessed_d_.widgets.listbarelement.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widgets.listbarelement.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widgets.listbarelement.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widgets.listbarelement.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widgets.listbarelement.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widgets.listbarelement.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widgets.listbarelement.md#_wrapcontent)
* [add](_declarations_blessed_d_.widgets.listbarelement.md#add)
* [addItem](_declarations_blessed_d_.widgets.listbarelement.md#additem)
* [addListener](_declarations_blessed_d_.widgets.listbarelement.md#addlistener)
* [append](_declarations_blessed_d_.widgets.listbarelement.md#append)
* [appendItem](_declarations_blessed_d_.widgets.listbarelement.md#appenditem)
* [clearBaseLine](_declarations_blessed_d_.widgets.listbarelement.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widgets.listbarelement.md#clearline)
* [clearPos](_declarations_blessed_d_.widgets.listbarelement.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widgets.listbarelement.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widgets.listbarelement.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widgets.listbarelement.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widgets.listbarelement.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widgets.listbarelement.md#deletetop)
* [destroy](_declarations_blessed_d_.widgets.listbarelement.md#destroy)
* [detach](_declarations_blessed_d_.widgets.listbarelement.md#detach)
* [disableDrag](_declarations_blessed_d_.widgets.listbarelement.md#disabledrag)
* [emit](_declarations_blessed_d_.widgets.listbarelement.md#emit)
* [emitAncestors](_declarations_blessed_d_.widgets.listbarelement.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widgets.listbarelement.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widgets.listbarelement.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widgets.listbarelement.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widgets.listbarelement.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widgets.listbarelement.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widgets.listbarelement.md#eventnames)
* [focus](_declarations_blessed_d_.widgets.listbarelement.md#focus)
* [forAncestors](_declarations_blessed_d_.widgets.listbarelement.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widgets.listbarelement.md#fordescendants)
* [free](_declarations_blessed_d_.widgets.listbarelement.md#free)
* [get](_declarations_blessed_d_.widgets.listbarelement.md#get)
* [getBaseLine](_declarations_blessed_d_.widgets.listbarelement.md#getbaseline)
* [getContent](_declarations_blessed_d_.widgets.listbarelement.md#getcontent)
* [getLine](_declarations_blessed_d_.widgets.listbarelement.md#getline)
* [getLines](_declarations_blessed_d_.widgets.listbarelement.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widgets.listbarelement.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widgets.listbarelement.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widgets.listbarelement.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widgets.listbarelement.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widgets.listbarelement.md#getscrollperc)
* [getText](_declarations_blessed_d_.widgets.listbarelement.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widgets.listbarelement.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widgets.listbarelement.md#hasdescendant)
* [hide](_declarations_blessed_d_.widgets.listbarelement.md#hide)
* [insert](_declarations_blessed_d_.widgets.listbarelement.md#insert)
* [insertAfter](_declarations_blessed_d_.widgets.listbarelement.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widgets.listbarelement.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widgets.listbarelement.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widgets.listbarelement.md#insertline)
* [insertTop](_declarations_blessed_d_.widgets.listbarelement.md#inserttop)
* [key](_declarations_blessed_d_.widgets.listbarelement.md#key)
* [kill](_declarations_blessed_d_.widgets.listbarelement.md#kill)
* [listenerCount](_declarations_blessed_d_.widgets.listbarelement.md#listenercount)
* [listeners](_declarations_blessed_d_.widgets.listbarelement.md#listeners)
* [move](_declarations_blessed_d_.widgets.listbarelement.md#move)
* [moveLeft](_declarations_blessed_d_.widgets.listbarelement.md#moveleft)
* [moveRight](_declarations_blessed_d_.widgets.listbarelement.md#moveright)
* [off](_declarations_blessed_d_.widgets.listbarelement.md#off)
* [on](_declarations_blessed_d_.widgets.listbarelement.md#on)
* [onScreenEvent](_declarations_blessed_d_.widgets.listbarelement.md#onscreenevent)
* [once](_declarations_blessed_d_.widgets.listbarelement.md#once)
* [onceKey](_declarations_blessed_d_.widgets.listbarelement.md#oncekey)
* [parseContent](_declarations_blessed_d_.widgets.listbarelement.md#parsecontent)
* [popLine](_declarations_blessed_d_.widgets.listbarelement.md#popline)
* [prepend](_declarations_blessed_d_.widgets.listbarelement.md#prepend)
* [prependListener](_declarations_blessed_d_.widgets.listbarelement.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widgets.listbarelement.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widgets.listbarelement.md#pushline)
* [rawListeners](_declarations_blessed_d_.widgets.listbarelement.md#rawlisteners)
* [remove](_declarations_blessed_d_.widgets.listbarelement.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widgets.listbarelement.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widgets.listbarelement.md#removehover)
* [removeItem](_declarations_blessed_d_.widgets.listbarelement.md#removeitem)
* [removeKey](_declarations_blessed_d_.widgets.listbarelement.md#removekey)
* [removeLabel](_declarations_blessed_d_.widgets.listbarelement.md#removelabel)
* [removeListener](_declarations_blessed_d_.widgets.listbarelement.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widgets.listbarelement.md#removescreenevent)
* [render](_declarations_blessed_d_.widgets.listbarelement.md#render)
* [resetScroll](_declarations_blessed_d_.widgets.listbarelement.md#resetscroll)
* [sattr](_declarations_blessed_d_.widgets.listbarelement.md#sattr)
* [screenshot](_declarations_blessed_d_.widgets.listbarelement.md#screenshot)
* [scroll](_declarations_blessed_d_.widgets.listbarelement.md#scroll)
* [scrollTo](_declarations_blessed_d_.widgets.listbarelement.md#scrollto)
* [select](_declarations_blessed_d_.widgets.listbarelement.md#select)
* [selectTab](_declarations_blessed_d_.widgets.listbarelement.md#selecttab)
* [set](_declarations_blessed_d_.widgets.listbarelement.md#set)
* [setBack](_declarations_blessed_d_.widgets.listbarelement.md#setback)
* [setBaseLine](_declarations_blessed_d_.widgets.listbarelement.md#setbaseline)
* [setContent](_declarations_blessed_d_.widgets.listbarelement.md#setcontent)
* [setFront](_declarations_blessed_d_.widgets.listbarelement.md#setfront)
* [setHover](_declarations_blessed_d_.widgets.listbarelement.md#sethover)
* [setIndex](_declarations_blessed_d_.widgets.listbarelement.md#setindex)
* [setItems](_declarations_blessed_d_.widgets.listbarelement.md#setitems)
* [setLabel](_declarations_blessed_d_.widgets.listbarelement.md#setlabel)
* [setLine](_declarations_blessed_d_.widgets.listbarelement.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widgets.listbarelement.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widgets.listbarelement.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widgets.listbarelement.md#setscrollperc)
* [setText](_declarations_blessed_d_.widgets.listbarelement.md#settext)
* [shiftLine](_declarations_blessed_d_.widgets.listbarelement.md#shiftline)
* [show](_declarations_blessed_d_.widgets.listbarelement.md#show)
* [strWidth](_declarations_blessed_d_.widgets.listbarelement.md#strwidth)
* [toggle](_declarations_blessed_d_.widgets.listbarelement.md#toggle)
* [unkey](_declarations_blessed_d_.widgets.listbarelement.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widgets.listbarelement.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widgets.listbarelement.md#listenercount-1)
...
⊕ **new ListbarElement**(opts: *[ListbarOptions](../interfaces/_declarations_blessed_d_.widgets.listbaroptions.md)*): [ListbarElement](_declarations_blessed_d_.widgets.listbarelement.md)
...
*Defined in [declarations/blessed.d.ts:2621](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2621)*

**Parameters:**

| Name | Type |
| ------ | ------ |
| opts | [ListbarOptions](../interfaces/_declarations_blessed_d_.widgets.listbaroptions.md) |

**Returns:** [ListbarElement](_declarations_blessed_d_.widgets.listbarelement.md)
...
**● commands**: *([ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md) & `object`)[]*

*Defined in [declarations/blessed.d.ts:2633](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2633)*

Current list of command objects (after being processed from options in object form). They have associated its corresponding item element.
...
**● items**: *([BlessedElement](_declarations_blessed_d_.widgets.blessedelement.md)<[ElementOptions](../interfaces/_declarations_blessed_d_.widgets.elementoptions.md)> & `object`)[]*

*Defined in [declarations/blessed.d.ts:2641](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2641)*

Elements representing each command. They can be used to reference commands (like indexes) in most of this class methods. The elements have associated its corresponding [ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md) object in property \[\[\_cmd\]\]
...
*Defined in [declarations/blessed.d.ts:2652](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2652)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widgets.listbarelement.md#position) property and emit [move](_declarations_blessed_d_.widgets.listbarelement.md#move) event.
...
*Defined in [declarations/blessed.d.ts:2647](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2647)*
...
*Defined in [declarations/blessed.d.ts:2627](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2627)*
...
▸ **add**(item: *[ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md) \| `function`*): `void`

▸ **add**(item: *`string`*, callback: *`function`*): `void`

*Defined in [declarations/blessed.d.ts:2674](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2674)*

Alias for [appendItem](_declarations_blessed_d_.widgets.listbarelement.md#appenditem).

**Parameters:**

| Name | Type |
| ------ | ------ |
| item | [ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md) \| `function` |

**Returns:** `void`

*Defined in [declarations/blessed.d.ts:2675](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2675)*
...
▸ **addItem**(item: *[ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md) \| `function`*): `void`

▸ **addItem**(item: *`string`*, callback: *`function`*): `void`

*Defined in [declarations/blessed.d.ts:2662](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2662)*
...
*Defined in [declarations/blessed.d.ts:2663](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2663)*
...
▸ **appendItem**(item: *[ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md) \| `function`*): `void`

▸ **appendItem**(item: *`string`*, callback: *`function`*): `void`

*Defined in [declarations/blessed.d.ts:2668](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2668)*
...
*Defined in [declarations/blessed.d.ts:2669](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2669)*
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `Optional` get | `boolean` |  it's passed to [\_getCoords](_declarations_blessed_d_.widgets.listbarelement.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widgets.listbarelement.md#hide) event.
...
*Defined in [declarations/blessed.d.ts:2693](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2693)*
...
*Defined in [declarations/blessed.d.ts:2698](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2698)*
...
*Defined in [declarations/blessed.d.ts:2703](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2703)*
...
▸ **on**(event: *"select item"*, listener: *`function`*): `this`

▸ **on**(event: *"select"*, listener: *`function`*): `this`

▸ **on**(event: *"cancel"*, listener: *`function`*): `this`

▸ **on**(event: *"set items"*, callback: *`function`*): `this`

▸ **on**(event: *"remove item"*, callback: *`function`*): `this`

▸ **on**(event: *"select tab"*, callback: *`function`*): `this`
...
*Defined in [declarations/blessed.d.ts:2710](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2710)*
...
*Defined in [declarations/blessed.d.ts:2715](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2715)*

Emitted when a command is activated (by pressing enter, or clicking, o by pressing [autoCommandKeys](../interfaces/_declarations_blessed_d_.widgets.listbaroptions.md#autocommandkeys).

*__see__*: \[\[ListBarElement\]\] class description.
...
*Defined in [declarations/blessed.d.ts:2720](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2720)*

Emitted when user moves thgourh the list items, with the arrow keys. @see \[\[ListBarElement\]\] class description.
...
*Defined in [declarations/blessed.d.ts:2725](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2725)*
...
*Defined in [declarations/blessed.d.ts:2726](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2726)*
...
*Defined in [declarations/blessed.d.ts:2731](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2731)*

Emitted when the items are initialized or reseted. This happens on initialization when method [setItems](_declarations_blessed_d_.widgets.listbarelement.md#setitems) is called.
...
*Defined in [declarations/blessed.d.ts:2735](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2735)*
...
*Defined in [declarations/blessed.d.ts:2739](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2739)*

Emitted when [autoCommandKeys](../interfaces/_declarations_blessed_d_.widgets.listbaroptions.md#autocommandkeys) is pressed. @see \[\[ListBarElement\]\] class description.
...
▸ **removeItem**(child: *`number` \| [BlessedElement](_declarations_blessed_d_.widgets.blessedelement.md)*): `void`

*Defined in [declarations/blessed.d.ts:2688](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2688)*
...
| Name | Type |
| ------ | ------ |
| child | `number` \| [BlessedElement](_declarations_blessed_d_.widgets.blessedelement.md) |
...
▸ **select**(offset: *`number` \| [BlessedElement](_declarations_blessed_d_.widgets.blessedelement.md)*): `void`

*Defined in [declarations/blessed.d.ts:2683](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2683)*

Select an item on the bar. Notice that the meaning of this method is equivalent to the user navigating thoguth the items with the arrow keys, not when its acctially actionain the commands. So the command callbacks are not called in this method. The same for other methods based on this one like [move](_declarations_blessed_d_.widgets.listbarelement.md#move), [moveLeft](_declarations_blessed_d_.widgets.listbarelement.md#moveleft), etc.

**Parameters:**

| Name | Type |
| ------ | ------ |
| offset | `number` \| [BlessedElement](_declarations_blessed_d_.widgets.blessedelement.md) |
...
*Defined in [declarations/blessed.d.ts:2708](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2708)*
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widgets.listbarelement.md#setindex)
...
▸ **setItems**(commands: *[ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md)[]*): `void`

*Defined in [declarations/blessed.d.ts:2657](https://github.com/cancerberoSgx/accursed/blob/978b980/src/declarations/blessed.d.ts#L2657)*
...
| Name | Type |
| ------ | ------ |
| commands | [ListbarCommand](../interfaces/_declarations_blessed_d_.widgets.types.listbarcommand.md)[] |
