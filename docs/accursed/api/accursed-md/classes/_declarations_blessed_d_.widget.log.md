[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [widget](../modules/_declarations_blessed_d_.widget.md) › [Log](_declarations_blessed_d_.widget.log.md)
...
* [IHasOptions](../interfaces/_declarations_blessed_d_.widgets.ihasoptions.md)‹[LogOptions](../interfaces/_declarations_blessed_d_.widgets.logoptions.md)›

## Index

### Constructors

* [constructor](_declarations_blessed_d_.widget.log.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widget.log.md#$)
* [_](_declarations_blessed_d_.widget.log.md#_)
* [_label](_declarations_blessed_d_.widget.log.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widget.log.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widget.log.md#abottom)
* [aleft](_declarations_blessed_d_.widget.log.md#aleft)
* [aright](_declarations_blessed_d_.widget.log.md#aright)
* [atop](_declarations_blessed_d_.widget.log.md#atop)
* [bg](_declarations_blessed_d_.widget.log.md#bg)
* [bold](_declarations_blessed_d_.widget.log.md#bold)
* [border](_declarations_blessed_d_.widget.log.md#border)
* [bottom](_declarations_blessed_d_.widget.log.md#bottom)
* [childBase](_declarations_blessed_d_.widget.log.md#childbase)
* [childOffset](_declarations_blessed_d_.widget.log.md#childoffset)
* [children](_declarations_blessed_d_.widget.log.md#children)
* [content](_declarations_blessed_d_.widget.log.md#content)
* [data](_declarations_blessed_d_.widget.log.md#data)
* [detached](_declarations_blessed_d_.widget.log.md#detached)
* [draggable](_declarations_blessed_d_.widget.log.md#draggable)
* [fg](_declarations_blessed_d_.widget.log.md#fg)
* [focusable](_declarations_blessed_d_.widget.log.md#focusable)
* [height](_declarations_blessed_d_.widget.log.md#height)
* [hidden](_declarations_blessed_d_.widget.log.md#hidden)
* [iheight](_declarations_blessed_d_.widget.log.md#iheight)
* [ileft](_declarations_blessed_d_.widget.log.md#ileft)
* [index](_declarations_blessed_d_.widget.log.md#index)
* [itop](_declarations_blessed_d_.widget.log.md#itop)
* [iwidth](_declarations_blessed_d_.widget.log.md#iwidth)
* [left](_declarations_blessed_d_.widget.log.md#left)
* [lpos](_declarations_blessed_d_.widget.log.md#lpos)
* [name](_declarations_blessed_d_.widget.log.md#name)
* [options](_declarations_blessed_d_.widget.log.md#options)
* [padding](_declarations_blessed_d_.widget.log.md#padding)
* [parent](_declarations_blessed_d_.widget.log.md#optional-parent)
* [position](_declarations_blessed_d_.widget.log.md#position)
* [rbottom](_declarations_blessed_d_.widget.log.md#rbottom)
* [right](_declarations_blessed_d_.widget.log.md#right)
* [rleft](_declarations_blessed_d_.widget.log.md#rleft)
* [rright](_declarations_blessed_d_.widget.log.md#rright)
* [rtop](_declarations_blessed_d_.widget.log.md#rtop)
* [screen](_declarations_blessed_d_.widget.log.md#screen)
* [scrollOnInput](_declarations_blessed_d_.widget.log.md#scrolloninput)
* [scrollback](_declarations_blessed_d_.widget.log.md#scrollback)
* [shrink](_declarations_blessed_d_.widget.log.md#shrink)
* [style](_declarations_blessed_d_.widget.log.md#style)
* [top](_declarations_blessed_d_.widget.log.md#top)
* [tpadding](_declarations_blessed_d_.widget.log.md#tpadding)
* [type](_declarations_blessed_d_.widget.log.md#type)
* [uid](_declarations_blessed_d_.widget.log.md#uid)
* [underline](_declarations_blessed_d_.widget.log.md#underline)
* [visible](_declarations_blessed_d_.widget.log.md#visible)
* [width](_declarations_blessed_d_.widget.log.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widget.log.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widget.log.md#_align)
* [_getBottom](_declarations_blessed_d_.widget.log.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widget.log.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widget.log.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widget.log.md#_getleft)
* [_getPos](_declarations_blessed_d_.widget.log.md#_getpos)
* [_getRight](_declarations_blessed_d_.widget.log.md#_getright)
* [_getShrink](_declarations_blessed_d_.widget.log.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widget.log.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widget.log.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widget.log.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widget.log.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widget.log.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widget.log.md#_wrapcontent)
* [add](_declarations_blessed_d_.widget.log.md#add)
* [addListener](_declarations_blessed_d_.widget.log.md#addlistener)
* [append](_declarations_blessed_d_.widget.log.md#append)
* [clearBaseLine](_declarations_blessed_d_.widget.log.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widget.log.md#clearline)
* [clearPos](_declarations_blessed_d_.widget.log.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widget.log.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widget.log.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widget.log.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widget.log.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widget.log.md#deletetop)
* [destroy](_declarations_blessed_d_.widget.log.md#destroy)
* [detach](_declarations_blessed_d_.widget.log.md#detach)
* [disableDrag](_declarations_blessed_d_.widget.log.md#disabledrag)
* [emit](_declarations_blessed_d_.widget.log.md#emit)
* [emitAncestors](_declarations_blessed_d_.widget.log.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widget.log.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widget.log.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widget.log.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widget.log.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widget.log.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widget.log.md#eventnames)
* [focus](_declarations_blessed_d_.widget.log.md#focus)
* [forAncestors](_declarations_blessed_d_.widget.log.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widget.log.md#fordescendants)
* [free](_declarations_blessed_d_.widget.log.md#free)
* [get](_declarations_blessed_d_.widget.log.md#get)
* [getBaseLine](_declarations_blessed_d_.widget.log.md#getbaseline)
* [getContent](_declarations_blessed_d_.widget.log.md#getcontent)
* [getLine](_declarations_blessed_d_.widget.log.md#getline)
* [getLines](_declarations_blessed_d_.widget.log.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widget.log.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widget.log.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widget.log.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widget.log.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widget.log.md#getscrollperc)
* [getText](_declarations_blessed_d_.widget.log.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widget.log.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widget.log.md#hasdescendant)
* [hide](_declarations_blessed_d_.widget.log.md#hide)
* [insert](_declarations_blessed_d_.widget.log.md#insert)
* [insertAfter](_declarations_blessed_d_.widget.log.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widget.log.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widget.log.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widget.log.md#insertline)
* [insertTop](_declarations_blessed_d_.widget.log.md#inserttop)
* [key](_declarations_blessed_d_.widget.log.md#key)
* [kill](_declarations_blessed_d_.widget.log.md#kill)
* [listenerCount](_declarations_blessed_d_.widget.log.md#listenercount)
* [listeners](_declarations_blessed_d_.widget.log.md#listeners)
* [log](_declarations_blessed_d_.widget.log.md#log)
* [off](_declarations_blessed_d_.widget.log.md#off)
* [on](_declarations_blessed_d_.widget.log.md#on)
* [onScreenEvent](_declarations_blessed_d_.widget.log.md#onscreenevent)
* [once](_declarations_blessed_d_.widget.log.md#once)
* [onceKey](_declarations_blessed_d_.widget.log.md#oncekey)
* [parseContent](_declarations_blessed_d_.widget.log.md#parsecontent)
* [popLine](_declarations_blessed_d_.widget.log.md#popline)
* [prepend](_declarations_blessed_d_.widget.log.md#prepend)
* [prependListener](_declarations_blessed_d_.widget.log.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widget.log.md#prependoncelistener)
* [pushLine](_declarations_blessed_d_.widget.log.md#pushline)
* [rawListeners](_declarations_blessed_d_.widget.log.md#rawlisteners)
* [remove](_declarations_blessed_d_.widget.log.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widget.log.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widget.log.md#removehover)
* [removeKey](_declarations_blessed_d_.widget.log.md#removekey)
* [removeLabel](_declarations_blessed_d_.widget.log.md#removelabel)
* [removeListener](_declarations_blessed_d_.widget.log.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widget.log.md#removescreenevent)
* [render](_declarations_blessed_d_.widget.log.md#render)
* [resetScroll](_declarations_blessed_d_.widget.log.md#resetscroll)
* [sattr](_declarations_blessed_d_.widget.log.md#sattr)
* [screenshot](_declarations_blessed_d_.widget.log.md#screenshot)
* [scroll](_declarations_blessed_d_.widget.log.md#scroll)
* [scrollTo](_declarations_blessed_d_.widget.log.md#scrollto)
* [set](_declarations_blessed_d_.widget.log.md#set)
* [setBack](_declarations_blessed_d_.widget.log.md#setback)
* [setBaseLine](_declarations_blessed_d_.widget.log.md#setbaseline)
* [setContent](_declarations_blessed_d_.widget.log.md#setcontent)
* [setFront](_declarations_blessed_d_.widget.log.md#setfront)
* [setHover](_declarations_blessed_d_.widget.log.md#sethover)
* [setIndex](_declarations_blessed_d_.widget.log.md#setindex)
* [setLabel](_declarations_blessed_d_.widget.log.md#setlabel)
* [setLine](_declarations_blessed_d_.widget.log.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widget.log.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widget.log.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widget.log.md#setscrollperc)
* [setText](_declarations_blessed_d_.widget.log.md#settext)
* [shiftLine](_declarations_blessed_d_.widget.log.md#shiftline)
* [show](_declarations_blessed_d_.widget.log.md#show)
* [strWidth](_declarations_blessed_d_.widget.log.md#strwidth)
* [toggle](_declarations_blessed_d_.widget.log.md#toggle)
* [unkey](_declarations_blessed_d_.widget.log.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widget.log.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widget.log.md#static-listenercount)

## Constructors

###  constructor

\+ **new Log**(`options?`: [LogOptions](../interfaces/_declarations_blessed_d_.widgets.logoptions.md)): *[Log](_declarations_blessed_d_.widget.log.md)*

*Inherited from [Log](_declarations_blessed_d_.widgets.log.md).[constructor](_declarations_blessed_d_.widgets.log.md#constructor)*
...
*Defined in [declarations/blessed.d.ts:3141](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L3141)*
...
**Returns:** *[Log](_declarations_blessed_d_.widget.log.md)*
...
*Inherited from [Log](_declarations_blessed_d_.widgets.log.md).[options](_declarations_blessed_d_.widgets.log.md#options)*
...
*Defined in [declarations/blessed.d.ts:3144](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L3144)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widget.log.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
*Inherited from [Log](_declarations_blessed_d_.widgets.log.md).[scrollOnInput](_declarations_blessed_d_.widgets.log.md#scrolloninput)*

*Defined in [declarations/blessed.d.ts:3154](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L3154)*
...
*Inherited from [Log](_declarations_blessed_d_.widgets.log.md).[scrollback](_declarations_blessed_d_.widgets.log.md#scrollback)*

*Defined in [declarations/blessed.d.ts:3149](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L3149)*
...
*Inherited from [Log](_declarations_blessed_d_.widgets.log.md).[add](_declarations_blessed_d_.widgets.log.md#add)*

*Defined in [declarations/blessed.d.ts:3164](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L3164)*
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widget.log.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widget.log.md#hide) event.
...
*Inherited from [Log](_declarations_blessed_d_.widgets.log.md).[log](_declarations_blessed_d_.widgets.log.md#log)*

*Defined in [declarations/blessed.d.ts:3159](https://github.com/cancerberoSgx/accursed/blob/468bf3c/src/declarations/blessed.d.ts#L3159)*
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widget.log.md#setindex)
