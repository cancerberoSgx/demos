[accursed](../README.md) › [Globals](../globals.md) › ["declarations/blessed.d"](../modules/_declarations_blessed_d_.md) › [widget](../modules/_declarations_blessed_d_.widget.md) › [Button](_declarations_blessed_d_.widget.button.md)
...
* [constructor](_declarations_blessed_d_.widget.button.md#constructor)

### Properties

* [$](_declarations_blessed_d_.widget.button.md#$)
* [_](_declarations_blessed_d_.widget.button.md#_)
* [_label](_declarations_blessed_d_.widget.button.md#optional-_label)
* [_noFill](_declarations_blessed_d_.widget.button.md#optional-_nofill)
* [abottom](_declarations_blessed_d_.widget.button.md#abottom)
* [aleft](_declarations_blessed_d_.widget.button.md#aleft)
* [aright](_declarations_blessed_d_.widget.button.md#aright)
* [atop](_declarations_blessed_d_.widget.button.md#atop)
* [bg](_declarations_blessed_d_.widget.button.md#bg)
* [bold](_declarations_blessed_d_.widget.button.md#bold)
* [border](_declarations_blessed_d_.widget.button.md#border)
* [bottom](_declarations_blessed_d_.widget.button.md#bottom)
* [childBase](_declarations_blessed_d_.widget.button.md#childbase)
* [childOffset](_declarations_blessed_d_.widget.button.md#childoffset)
* [children](_declarations_blessed_d_.widget.button.md#children)
* [content](_declarations_blessed_d_.widget.button.md#content)
* [data](_declarations_blessed_d_.widget.button.md#data)
* [detached](_declarations_blessed_d_.widget.button.md#detached)
* [draggable](_declarations_blessed_d_.widget.button.md#draggable)
* [fg](_declarations_blessed_d_.widget.button.md#fg)
* [focusable](_declarations_blessed_d_.widget.button.md#focusable)
* [height](_declarations_blessed_d_.widget.button.md#height)
* [hidden](_declarations_blessed_d_.widget.button.md#hidden)
* [iheight](_declarations_blessed_d_.widget.button.md#iheight)
* [ileft](_declarations_blessed_d_.widget.button.md#ileft)
* [index](_declarations_blessed_d_.widget.button.md#index)
* [itop](_declarations_blessed_d_.widget.button.md#itop)
* [iwidth](_declarations_blessed_d_.widget.button.md#iwidth)
* [left](_declarations_blessed_d_.widget.button.md#left)
* [lpos](_declarations_blessed_d_.widget.button.md#lpos)
* [name](_declarations_blessed_d_.widget.button.md#name)
* [options](_declarations_blessed_d_.widget.button.md#options)
* [padding](_declarations_blessed_d_.widget.button.md#padding)
* [parent](_declarations_blessed_d_.widget.button.md#optional-parent)
* [position](_declarations_blessed_d_.widget.button.md#position)
* [rbottom](_declarations_blessed_d_.widget.button.md#rbottom)
* [right](_declarations_blessed_d_.widget.button.md#right)
* [rleft](_declarations_blessed_d_.widget.button.md#rleft)
* [rright](_declarations_blessed_d_.widget.button.md#rright)
* [rtop](_declarations_blessed_d_.widget.button.md#rtop)
* [screen](_declarations_blessed_d_.widget.button.md#screen)
* [shrink](_declarations_blessed_d_.widget.button.md#shrink)
* [style](_declarations_blessed_d_.widget.button.md#style)
* [top](_declarations_blessed_d_.widget.button.md#top)
* [tpadding](_declarations_blessed_d_.widget.button.md#tpadding)
* [type](_declarations_blessed_d_.widget.button.md#type)
* [uid](_declarations_blessed_d_.widget.button.md#uid)
* [underline](_declarations_blessed_d_.widget.button.md#underline)
* [visible](_declarations_blessed_d_.widget.button.md#visible)
* [width](_declarations_blessed_d_.widget.button.md#width)
* [defaultMaxListeners](_declarations_blessed_d_.widget.button.md#static-defaultmaxlisteners)

### Methods

* [_align](_declarations_blessed_d_.widget.button.md#_align)
* [_getBottom](_declarations_blessed_d_.widget.button.md#_getbottom)
* [_getCoords](_declarations_blessed_d_.widget.button.md#_getcoords)
* [_getHeight](_declarations_blessed_d_.widget.button.md#_getheight)
* [_getLeft](_declarations_blessed_d_.widget.button.md#_getleft)
* [_getPos](_declarations_blessed_d_.widget.button.md#_getpos)
* [_getRight](_declarations_blessed_d_.widget.button.md#_getright)
* [_getShrink](_declarations_blessed_d_.widget.button.md#_getshrink)
* [_getShrinkBox](_declarations_blessed_d_.widget.button.md#_getshrinkbox)
* [_getTop](_declarations_blessed_d_.widget.button.md#_gettop)
* [_getWidth](_declarations_blessed_d_.widget.button.md#_getwidth)
* [_parseAttr](_declarations_blessed_d_.widget.button.md#_parseattr)
* [_parseTags](_declarations_blessed_d_.widget.button.md#_parsetags)
* [_wrapContent](_declarations_blessed_d_.widget.button.md#_wrapcontent)
* [addListener](_declarations_blessed_d_.widget.button.md#addlistener)
* [append](_declarations_blessed_d_.widget.button.md#append)
* [clearBaseLine](_declarations_blessed_d_.widget.button.md#clearbaseline)
* [clearLine](_declarations_blessed_d_.widget.button.md#clearline)
* [clearPos](_declarations_blessed_d_.widget.button.md#clearpos)
* [collectAncestors](_declarations_blessed_d_.widget.button.md#collectancestors)
* [collectDescendants](_declarations_blessed_d_.widget.button.md#collectdescendants)
* [deleteBottom](_declarations_blessed_d_.widget.button.md#deletebottom)
* [deleteLine](_declarations_blessed_d_.widget.button.md#deleteline)
* [deleteTop](_declarations_blessed_d_.widget.button.md#deletetop)
* [destroy](_declarations_blessed_d_.widget.button.md#destroy)
* [detach](_declarations_blessed_d_.widget.button.md#detach)
* [disableDrag](_declarations_blessed_d_.widget.button.md#disabledrag)
* [emit](_declarations_blessed_d_.widget.button.md#emit)
* [emitAncestors](_declarations_blessed_d_.widget.button.md#emitancestors)
* [emitDescendants](_declarations_blessed_d_.widget.button.md#emitdescendants)
* [enableDrag](_declarations_blessed_d_.widget.button.md#enabledrag)
* [enableInput](_declarations_blessed_d_.widget.button.md#enableinput)
* [enableKeys](_declarations_blessed_d_.widget.button.md#enablekeys)
* [enableMouse](_declarations_blessed_d_.widget.button.md#enablemouse)
* [eventNames](_declarations_blessed_d_.widget.button.md#eventnames)
* [focus](_declarations_blessed_d_.widget.button.md#focus)
* [forAncestors](_declarations_blessed_d_.widget.button.md#forancestors)
* [forDescendants](_declarations_blessed_d_.widget.button.md#fordescendants)
* [free](_declarations_blessed_d_.widget.button.md#free)
* [get](_declarations_blessed_d_.widget.button.md#get)
* [getBaseLine](_declarations_blessed_d_.widget.button.md#getbaseline)
* [getContent](_declarations_blessed_d_.widget.button.md#getcontent)
* [getLine](_declarations_blessed_d_.widget.button.md#getline)
* [getLines](_declarations_blessed_d_.widget.button.md#getlines)
* [getMaxListeners](_declarations_blessed_d_.widget.button.md#getmaxlisteners)
* [getScreenLines](_declarations_blessed_d_.widget.button.md#getscreenlines)
* [getScroll](_declarations_blessed_d_.widget.button.md#getscroll)
* [getScrollHeight](_declarations_blessed_d_.widget.button.md#getscrollheight)
* [getScrollPerc](_declarations_blessed_d_.widget.button.md#getscrollperc)
* [getText](_declarations_blessed_d_.widget.button.md#gettext)
* [hasAncestor](_declarations_blessed_d_.widget.button.md#hasancestor)
* [hasDescendant](_declarations_blessed_d_.widget.button.md#hasdescendant)
* [hide](_declarations_blessed_d_.widget.button.md#hide)
* [insert](_declarations_blessed_d_.widget.button.md#insert)
* [insertAfter](_declarations_blessed_d_.widget.button.md#insertafter)
* [insertBefore](_declarations_blessed_d_.widget.button.md#insertbefore)
* [insertBottom](_declarations_blessed_d_.widget.button.md#insertbottom)
* [insertLine](_declarations_blessed_d_.widget.button.md#insertline)
* [insertTop](_declarations_blessed_d_.widget.button.md#inserttop)
* [key](_declarations_blessed_d_.widget.button.md#key)
* [kill](_declarations_blessed_d_.widget.button.md#kill)
* [listenerCount](_declarations_blessed_d_.widget.button.md#listenercount)
* [listeners](_declarations_blessed_d_.widget.button.md#listeners)
* [off](_declarations_blessed_d_.widget.button.md#off)
* [on](_declarations_blessed_d_.widget.button.md#on)
* [onScreenEvent](_declarations_blessed_d_.widget.button.md#onscreenevent)
* [once](_declarations_blessed_d_.widget.button.md#once)
* [onceKey](_declarations_blessed_d_.widget.button.md#oncekey)
* [parseContent](_declarations_blessed_d_.widget.button.md#parsecontent)
* [popLine](_declarations_blessed_d_.widget.button.md#popline)
* [prepend](_declarations_blessed_d_.widget.button.md#prepend)
* [prependListener](_declarations_blessed_d_.widget.button.md#prependlistener)
* [prependOnceListener](_declarations_blessed_d_.widget.button.md#prependoncelistener)
* [press](_declarations_blessed_d_.widget.button.md#press)
* [pushLine](_declarations_blessed_d_.widget.button.md#pushline)
* [rawListeners](_declarations_blessed_d_.widget.button.md#rawlisteners)
* [remove](_declarations_blessed_d_.widget.button.md#remove)
* [removeAllListeners](_declarations_blessed_d_.widget.button.md#removealllisteners)
* [removeHover](_declarations_blessed_d_.widget.button.md#removehover)
* [removeKey](_declarations_blessed_d_.widget.button.md#removekey)
* [removeLabel](_declarations_blessed_d_.widget.button.md#removelabel)
* [removeListener](_declarations_blessed_d_.widget.button.md#removelistener)
* [removeScreenEvent](_declarations_blessed_d_.widget.button.md#removescreenevent)
* [render](_declarations_blessed_d_.widget.button.md#render)
* [resetScroll](_declarations_blessed_d_.widget.button.md#resetscroll)
* [sattr](_declarations_blessed_d_.widget.button.md#sattr)
* [screenshot](_declarations_blessed_d_.widget.button.md#screenshot)
* [scroll](_declarations_blessed_d_.widget.button.md#scroll)
* [scrollTo](_declarations_blessed_d_.widget.button.md#scrollto)
* [set](_declarations_blessed_d_.widget.button.md#set)
* [setBack](_declarations_blessed_d_.widget.button.md#setback)
* [setBaseLine](_declarations_blessed_d_.widget.button.md#setbaseline)
* [setContent](_declarations_blessed_d_.widget.button.md#setcontent)
* [setFront](_declarations_blessed_d_.widget.button.md#setfront)
* [setHover](_declarations_blessed_d_.widget.button.md#sethover)
* [setIndex](_declarations_blessed_d_.widget.button.md#setindex)
* [setLabel](_declarations_blessed_d_.widget.button.md#setlabel)
* [setLine](_declarations_blessed_d_.widget.button.md#setline)
* [setMaxListeners](_declarations_blessed_d_.widget.button.md#setmaxlisteners)
* [setScroll](_declarations_blessed_d_.widget.button.md#setscroll)
* [setScrollPerc](_declarations_blessed_d_.widget.button.md#setscrollperc)
* [setText](_declarations_blessed_d_.widget.button.md#settext)
* [shiftLine](_declarations_blessed_d_.widget.button.md#shiftline)
* [show](_declarations_blessed_d_.widget.button.md#show)
* [strWidth](_declarations_blessed_d_.widget.button.md#strwidth)
* [toggle](_declarations_blessed_d_.widget.button.md#toggle)
* [unkey](_declarations_blessed_d_.widget.button.md#unkey)
* [unshiftLine](_declarations_blessed_d_.widget.button.md#unshiftline)
* [listenerCount](_declarations_blessed_d_.widget.button.md#static-listenercount)

## Constructors

###  constructor

\+ **new Button**(`opts`: [ButtonOptions](../interfaces/_declarations_blessed_d_.widgets.buttonoptions.md)): *[Button](_declarations_blessed_d_.widget.button.md)*

*Inherited from [ButtonElement](_declarations_blessed_d_.widgets.buttonelement.md).[constructor](_declarations_blessed_d_.widgets.buttonelement.md#constructor)*
...
**Returns:** *[Button](_declarations_blessed_d_.widget.button.md)*
...
*Inherited from [ButtonElement](_declarations_blessed_d_.widgets.buttonelement.md).[options](_declarations_blessed_d_.widgets.buttonelement.md#options)*
...
Setting this property will cause the element to change element's [position](_declarations_blessed_d_.widget.button.md#position) property and emit [move](_declarations_blessedprogram_d_.blessedprogram.md#move) event.
...
Name | Type | Description |
------ | ------ | ------ |
`get?` | boolean | it's passed to [_getCoords](_declarations_blessed_d_.widget.button.md#_getcoords) |
...
Hide element, clear the element's region on the screen and triggers [hide](_declarations_blessed_d_.widget.button.md#hide) event.
...
*Inherited from [ButtonElement](_declarations_blessed_d_.widgets.buttonelement.md).[on](_declarations_blessed_d_.widgets.buttonelement.md#on)*
...
*Inherited from [ButtonElement](_declarations_blessed_d_.widgets.buttonelement.md).[press](_declarations_blessed_d_.widgets.buttonelement.md#press)*
...
Put the element in front of its siblings. Uses [setIndex](_declarations_blessed_d_.widget.button.md#setindex)
